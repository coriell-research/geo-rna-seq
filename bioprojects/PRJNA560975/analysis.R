...
cm <- makeContrasts(
  Tedizolid.5uM_vs_DMSO = tedizolid.5uM - dmso,
  Venetoclax.500nM_vs_DMSO = venetoclax.500nM - dmso,
  Venetoclax.500nM_Tedizolid.5uM_vs_DMSO = venetoclax.500nM_tedizolid.5uM - dmso,
  levels = design
)
