...
cm <- makeContrasts(
  NCH1681.Decitabine_NCH1681.DMSO = NCH1681.DAC - NCH1681.DMSO,
  NCH612.Decitabine_vs_NCH612.DMSO = NCH612.DAC - NCH612.DMSO,
  SU_AO3.Decitabine_vs_SU_AO3.DMSO = SU_AO3.DAC - SU_AO3.DMSO,
  TS603.Decitabine_vs_TS603.DMSO = TS603.DAC - TS603.DMSO,
  Decitabine_vs_DMSO = ((NCH1681.DAC + NCH612.DAC + SU_AO3.DAC + TS603.DAC) / 4) - 
    ((NCH1681.DMSO + NCH612.DMSO + SU_AO3.DMSO + TS603.DMSO) / 4), 
  levels = design
)
