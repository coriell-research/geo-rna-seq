...
cm <- makeContrasts(
  x501mel_SCDi_A93_t48h_vs_x501mel_DMSO_t48h = x501mel_SCDi_A93_t48h - x501mel_DMSO_t48h,
  x501mel_siCTR_1_t48h_vs_x501mel_DMSO_t48h = x501mel_siCTR_1_t48h - x501mel_DMSO_t48h,
  x501mel_siCTR_t48h_vs_x501mel_DMSO_t48h = x501mel_siCTR_t48h - x501mel_DMSO_t48h,
  x501mel_siSCD_1_t48_vs_x501mel_DMSO_t48h = x501mel_siSCD_1_t48h - x501mel_DMSO_t48h,
  x501mel_siSCD_2_t48h_vs_x501mel_DMSO_t48h = x501mel_siSCD_2_t48h - x501mel_DMSO_t48h,
  IGR37_SCDi_A93_t48h_vs_IGR37_DMSO_t48h = IGR37_SCDi_A93_t48h - IGR37_DMSO_t48h,
  IGR37_siCTR_1_t48h_vs_IGR37_DMSO_t48h = IGR37_siCTR_1_t48h - IGR37_DMSO_t48h,
  IGR37_siCTR_t48h_vs_IGR37_DMSO_t48h = IGR37_siCTR_t48h - IGR37_DMSO_t48h,
  IGR37_siSCD_1_t48h_vs_IGR37_DMSO_t48h = IGR37_siSCD_1_t48h - IGR37_DMSO_t48h,
  IGR37_siSCD_2_t48h_vs_IGR37_DMSO_t48h = IGR37_siSCD_2_t48h - IGR37_DMSO_t48h,
  levels = design
)
