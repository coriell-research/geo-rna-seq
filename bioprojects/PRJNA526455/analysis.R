...
cm <- makeContrasts(
  SUM159.shCTRL.Gemcitabine.24hr_vs_shCTRL.Untreated.24hr = SUM159.shCTRL.Gemcitabine.treated.24hr - SUM159.shCTRL.Untreated.24hr,
  SUM159.shE4F1.Gemcitabine.24hr_vs_shE4F1.Untreated.24hr = SUM159.shE4F1.Gemcitabine.treated.24hr - SUM159.shE4F1.Untreated.24hr,
  levels = design
)
