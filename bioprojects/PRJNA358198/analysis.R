...
cm <- makeContrasts(
  HeLa.200Uml_IFNy_vs_HeLa.control = HeLa.200Uml_IFNy - HeLa.control,
  Jar.200Uml_IFNy_vs_Jar.control = Jar.200Uml_IFNy - Jar.control,
  Jar.Pervanadate_100uM_vs_Jar.control = Jar.Pervanadate_100uM - Jar.control,
  Jar.Pervanadate_100uM_200Uml_IFNy_vs_Jar.control = Jar.Pervanadate_100uM_200Uml_IFNy - Jar.control,
  Jar.ValproicAcid_5nM_vs_Jar.control = Jar.ValproicAcid_5nM - Jar.control,
  Jar.ValproicAcid_5nM_200Uml_IFNy_vs_Jar.control = Jar.ValproicAcid_5nM_200Uml_IFNy - Jar.control, 
  levels = design
)
