...
cm <- makeContrasts(
  A375.Etoposide.Rapamycin_vs_Etoposide = A375.Etoposide...Rapamycin - A375.Etoposide,
  SK.MEL.28.Etoposide.Rapamycin_vs_Etoposide = SK.MEL.28.Etoposide...Rapamycin - SK.MEL.28.Etoposide,
