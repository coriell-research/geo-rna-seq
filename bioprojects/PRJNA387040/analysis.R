...
cm <- makeContrasts(
  cGAS_WT.Etoposide_vs_cGAS_WT.Control = wt.etoposide - wt.control,
  cGAS_KO.Etoposide_vs_cGAS_WT.Control = ko_cGAS.etoposide - wt.control,
  Etoposide_vs_Control = ((wt.etoposide + ko_cGAS.etoposide) / 2) - wt.control,
  levels = design
)
