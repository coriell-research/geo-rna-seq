...
cm <- makeContrasts(
  MKL_1.GSK_LSD10.1uM.3_vs_MKL_1.Control.3 = MKL_1.GSK_LSD10.1uM.3 - MKL_1.Control.3,
  MS_1.GSK_LSD10.1uM.3_vs_MS_1.Control.3 = MS_1.GSK_LSD10.1uM.3 - MS_1.Control.3,
  MKL_2.CPI_670242.1_vs_MKL_2.Control.1 = MKL_2.CPI_670242.1 - MKL_2.Control.1,
  WaGa.CPI_670242.1_vs_WaGa.Control.1 = WaGa.CPI_670242.1 - WaGa.Control.1,
  PeTa.CPI_670242.1_vs_PeTa.Control.1 = PeTa.CPI_670242.1 - PeTa.Control.1,
  BroLi.CPI_670242.1_vs_BroLi.Control.1 = BroLi.CPI_670242.1 - BroLi.Control.1,
  UISO.CPI_670242.1_vs_UISO.Control.1 = UISO.CPI_670242.1 - UISO.Control.1,
  levels = design
)
