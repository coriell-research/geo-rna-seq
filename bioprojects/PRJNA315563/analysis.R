...
cm <- makeContrasts(
  HeLa.BI_7273_vs_DMSO = HeLa.BI_7273 - HeLa.DMSO,
  HL60.Myc_amplification.BI_7273_vs_Myc_amplification.DMSO = HL60.Myc_amplification.BI_7273 - HL60.Myc_amplification.DMSO,
  MV411.MLL_AF4.BI_7273_vs_MLL_AF4.DMSO = MV411.MLL_AF4.BI_7273 - MV411.MLL_AF4.DMSO,
  levels = design
)
