...
metadata <- unique(metadata[, .(BioSample, group, egfr.status)])
...
qtest <- quantro(logcounts, groupFactor = metadata$egfr.status, B = 1e3)
qaov <- anova(qtest)
...
cm <- makeContrasts(
  L0125.egfr.low.BMP4_vs_egfr.low.Untreated  = L0125.egfr.low.BMP4 - L0125.egfr.low.Untreated, 
  L0125.egfr.low.BMP4.and.Temozolomide_vs_egfr.low.Untreated = L0125.egfr.low.BMP4.and.Temozolomide - L0125.egfr.low.Untreated, 
  L0125.egfr.low.Temozlomide_vs_egfr.low.Untreated = L0125.egfr.low.Temozlomide - L0125.egfr.low.Untreated, 
  L0125.egfr.high.BMP4_vs_egfr.high.Untreated = L0615.egfr.high.BMP4 - L0615.egfr.high.Untreated, 
  L0125.egfr.high.BMP4.and.Temozolomide_vs_egfr.high.Untreated = L0615.egfr.high.BMP4.and.Temozolomide - L0615.egfr.high.Untreated, 
  L0125.egfr.high.Temozlomide_vs_egfr.high.Untreated = L0615.egfr.high.Temozlomide - L0615.egfr.high.Untreated,
  levels = design
)
