...
cm <- makeContrasts(
  Loucy.Decitabine_vs_Loucy.DMSO = Loucy.Decitabine - Loucy.DMSO,
  MOLT_16.Decitabine_vs_MOLT_16.DMSO = MOLT_16.Decitabine - MOLT_16.DMSO,
  PEER.Decitabine_vs_PEER.DMSO = PEER.Decitabine - PEER.DMSO,
  PER_117.Decitabine_vs_PER_117.DMSO = PER_117.Decitabine - PER_117.DMSO,
  TALL_1.Decitabine_vs_T_ALL.DMSO = TALL_1.Decitabine - TALL_1.DMSO,
  Decitabine_vs_DMSO = ((Loucy.Decitabine + MOLT_16.Decitabine + PEER.Decitabine + PER_117.Decitabine + TALL_1.Decitabine) / 5) - 
    ((Loucy.DMSO + MOLT_16.DMSO + PEER.DMSO + PER_117.DMSO + TALL_1.DMSO) / 5),
  levels = design
)
