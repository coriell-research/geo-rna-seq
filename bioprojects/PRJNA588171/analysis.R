...
cm <- makeContrasts(
  Caco2.Lactoferrin.4hr_vs_control.4hr = Caco2.Lactoferrin.4hr - Caco2.control.4hr,
  Caco2.Methotrexate.4hr_vs_control.4hr= Caco2.Methotrexate.4hr - Caco2.control.4hr,
  Caco2.Methotrexate.Lactoferrin.4hr_vs_control.4hr= Caco2.Methotrexate.Lactoferrin.4hr - Caco2.control.4hr,
  levels = design
)
