...
cm <- makeContrasts(
  ...
  x4GY_vs_Control = ((A498.4GY_3hr + A549.4GY_3hr + H460.4GY_3hr + 
                      HCT116.4GY_3hr + LOXIMVI.4GY_3hr + MALME3.4GY_3hr +
                      MCF7.4GY_3hr + SKMEL5.4GY_3hr + U2OS.4GY_3hr +
                      UACC257.4GY_3hr + UO31.4GY_3hr) / 11) - 
    ((A498.control + A549.control + H460.control + HCT116.control +
      LOXIMVI.control + MALME3.control + MCF7.control + SKMEL5.control +
      U2OS.control + UACC257.control + UO31.control) / 11),
  levels = design
)
