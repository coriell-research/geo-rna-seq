...
cm <- makeContrasts(
  LNCaP.24.ARD61_vs_LNCaP.24.noARD61 = LNCaP.24.ARD61 - LNCaP.24.noARD61, 
  LNCaPARV7.24.ARD61_vs_LNCaPARV7.24.noARD61 = LNCaPARV7.24.ARD61 - LNCaPARV7.24.noARD61,
  LNCaPEnzR.24.ARD61_vs_LNCaPEnzR.24.noARD61 = LNCaPEnzR.24.ARD61 - LNCaPEnzR.24.noARD61,
  VCaP.6.ARD61_vs_VCaP.6.noARD61 = VCaP.6.ARD61 - VCaP.6.noARD61, 
  levels = design
)
