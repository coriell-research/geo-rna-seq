...
cm <- makeContrasts(
  A549.Cytosol.Cisplatin_vs_A549.Cytosol.DMSO. = A549.Cytosol.Cisplatin - A549.Cytosol.Vehicle..DMSO.,
  A549.Polysomes.Cisplatin_vs_A549.Polysomes.DMSO. = A549.Polysomes.Cisplatin - A549.Polysomes.Vehicle..DMSO.,
  A549R.Cytosol.Cisplatin_vs_A549R.Cytosol.DMSO. = A549R.Cytosol.Cisplatin -  A549R.Cytosol.Vehicle..DMSO., 
  H358.Total.cells.Cisplatin_vs_H358.Total.cells.DMSO.= H358.Total.cells.Cisplatin - H358.Total.cells.Vehicle..DMSO.,
  H358.Total.cells.Oxaliplatin_vs_H358.Total.cells.DMSO = H358.Total.cells.Oxaliplatin - H358.Total.cells.Vehicle..DMSO.,
  levels = design
)
