...
setDT(metadata)
metadata[c(2,4,6,8,10,12,14,16),group := substr(metadata$group[c(2,4,6,8,10,12,14,16)],1,nchar(metadata$group[c(2,4,6,8,10,12,14,16)])-1)] 
setDF(metadata,rownames = metadata$BioSample)
...
cm <- makeContrasts(
  Mia.PaCa.2.40nM.Gem2.24hr_vs_Mia.PaCa.2.Ctrl.24hr = Mia.PaCa.2.40nM.Gem2.24hr -  Mia.PaCa.2.Ctrl.24hr, 
  Mia.PaCa.2.50uM.Gen...40nM.Gem2.24hr_vs_Mia.PaCa.2.Ctrl.24hr = Mia.PaCa.2.50uM.Gen...40nM.Gem2.24hr - Mia.PaCa.2.Ctrl.24hr,
  Mia.PaCa.2.50uM.Gen.24hr_vs_Mia.PaCa.2.Ctrl.24hr = Mia.PaCa.2.50uM.Gen.24hr - Mia.PaCa.2.Ctrl.24hr,
  PANC.1.40nM.Gem2.24hr_vs_PANC.1.Ctrl.24hr= PANC.1.40nM.Gem2.24hr - PANC.1.Ctrl.24hr,
  PANC.1.50uM.Gen...40nM.Gem2.24hr_vs_PANC.1.Ctrl.24hr = PANC.1.50uM.Gen...40nM.Gem2.24hr - PANC.1.Ctrl.24hr,
  PANC.1.50uM.Gen.24hr_vs_PANC.1.Ctrl.24hr = PANC.1.50uM.Gen.24hr - PANC.1.Ctrl.24hr,
