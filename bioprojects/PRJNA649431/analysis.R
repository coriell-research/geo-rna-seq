...
cm <- makeContrasts(
  PDX_TALL1.Decitabine_vs_PDX_TALL1.DMSO = PDX_TALL1.dac - PDX_TALL1.dmso,
  PDX_TALL2.Decitabine_vs_PDX_TALL2.DMSO = PDX_TALL2.dac - PDX_TALL2.dmso,
  PDX_TALL.Decitabine_vs_PDX_TALL.DMSO = ((PDX_TALL1.dac + PDX_TALL2.dac) / 2) - 
    ((PDX_TALL1.dmso + PDX_TALL2.dmso) / 2),
  levels = design
)
