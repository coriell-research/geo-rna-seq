...
# Drop single sample
mae <- mae[, mae$group != "responder.CMML2"]
...
cm <- makeContrasts(
  Decitabine_Responder_vs_Non_Responder = responder.CMML1 - (non_responder.CMML1 + non_responder.CMML2) / 2,
  levels = design
)
