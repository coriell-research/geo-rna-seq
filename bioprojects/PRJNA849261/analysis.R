...
cm <- makeContrasts(
  U2940.Brentuximab.vedotin.25ng.ul_vs_U.2940.Untreated.RPMI = U.2940.Brentuximab.vedotin..BV..25ng.ul. -  U.2940.Untreated..UT..RPMI.media.,
  U2940.Ibrutinib.2.5uM_vs_U.2940.Untreated.RPMI = U.2940.Ibrutinib..IBR..2.5uM. - U.2940.Untreated..UT..RPMI.media.,
  U2940.Prednisone.60ug.ml_vs_U.2940.Untreated.RPMI = U.2940.Prednisone..PRED..60ug.ml. - U.2940.Untreated..UT..RPMI.media.,
  U2940.Rituximab.200ug.ml_vs_U.2940.Untreated.RPMI = U.2940.Rituximab..RmAb..200ug.ml. - U.2940.Untreated..UT..RPMI.media.,
  L428.Brentuximab.vedotin.25ng.ul.48hrs_vs_Untreated.RPMI.media.48hrs = L.428.Brentuximab.vedotin..BV..25ng.ul.48.hours - L.428.Untreated..UT..RPMI.media.48.hours,
  L428.Ibrutinib.2.5uM.48hrs_vs_Untreated.RPMI.media.48.hrs = L.428.Ibrutinib..IBR..2.5uM.48.hours - L.428.Untreated..UT..RPMI.media.48.hours,
  L428.Prednisone.60ug.ml.48hrs_vs_L.428.Untreated.RPMI.48hrs = L.428.Prednisone..PRED..60ug.ml.48.hours - L.428.Untreated..UT..RPMI.media.48.hours,
  L428.Rituximab.200ug.ml.48.hrs_vs_Untreated.RPMI.media.48hrs = L.428.Rituximab..RmAb..200ug.ml.48.hours - L.428.Untreated..UT..RPMI.media.48.hours,
  KARPAS.1106P.Brentuximab.vedotin.25ng.ul.48hrs_vs_Untreated.RPMI.48hrs = KARPAS.1106P.Brentuximab.vedotin..BV..25ng.ul.48.hours - KARPAS.1106P.Untreated..UT..RPMI.media.48.hours,
  KARPAS.1106P.Ibrutinib.2.5uM.48hrs_vs_Untreated.RPMI.48hrs = KARPAS.1106P.Ibrutinib..IBR..2.5uM.48.hours - KARPAS.1106P.Untreated..UT..RPMI.media.48.hours,
  KARPAS.1106P.Prednisone.60ug.ml.48hrs_vs_Untreated.RPMI.48hrs = KARPAS.1106P.Prednisone..PRED..60ug.ml.48.hours - KARPAS.1106P.Untreated..UT..RPMI.media.48.hours,
  KARPAS.1106P.Rituximab.200ug.ml.48hrs_vs_Untreated.RPMI.48hrs = KARPAS.1106P.Rituximab..RmAb..200ug.ml.48.hours - KARPAS.1106P.Untreated..UT..RPMI.media.48.hours, 
  HDML2.Brentuximab.vedotin.25ng.ul.48hrs_vs_Untreated.RPMI.48hrs = HDML.2.Brentuximab.vedotin..BV..25ng.ul.48.hours - HDML.2.Untreated..UT..RPMI.media.48.hours,
  HDML2.Ibrutinib.2.5uM.48hrs_vs_Untreated.RPMI.48hrs = HDML.2.Ibrutinib..IBR..2.5uM.48.hours - HDML.2.Untreated..UT..RPMI.media.48.hours,
  HDML2.Prednisone.60ug.ml.48hrs_vs_Untreated.RPMI.48hrs = HDML.2.Prednisone..PRED..60ug.ml.48.hours - HDML.2.Untreated..UT..RPMI.media.48.hours,
  HDML2.Rituximab.200ug.ml.48hrs_vs_Untreated.RPMI.48hrs = HDML.2.Rituximab..RmAb..200ug.ml.48.hours - HDML.2.Untreated..UT..RPMI.media.48.hours,
  levels = design
)
