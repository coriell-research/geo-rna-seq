...
cm <- makeContrasts(
  MOLM13.VenetoclaxResistant_vs_Parental = MOLM13_VR - MOLM13_Par,
  MV411.VenetoclaxResistant_vs_Parental = MV411_VR - MV411_Par,
  MOLM13_Cas9_dBSD.sgCLPB1_vs_sgRosa_day6 = MOLM13_sgCLPB1_D6 - MOLM13_sgRosa_D6,
  MOLM13_Cas9_dBSD.sgCLPB1_vs_sgRosa_day8 = (MOLM13_sgCLPB1_D8 - MOLM13_sgCLPB1_D6) - (MOLM13_sgRosa_D8 - MOLM13_sgRosa_D6),
  MOLM13_Cas9_dBSD.sgCLPB2_vs_sgRosa_day6 = MOLM13_sgCLPB2_D6 - MOLM13_sgRosa_D6,
  MOLM13_Cas9_dBSD.sgCLPB2_vs_sgRosa_day8 = (MOLM13_sgCLPB2_D8 - MOLM13_sgCLPB1_D6) - (MOLM13_sgRosa_D8 - MOLM13_sgRosa_D6),
  levels = design
)
