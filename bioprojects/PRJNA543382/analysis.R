...
# Drop outliers -- seems like K562 was done in two batches and one is bad.
outliers <- c("SAMN11665357", "SAMN11665351", "SAMN11665353", "SAMN11665355")
...
# Add additional metadata for cell line
metadata$cell_line <- ifelse(metadata$group %like% "Jurkat", "Jurkat", "K562")
