...
cm <- makeContrasts(
  CDK13R860Q_control_vs_control = CDK13R860Q_control - control,
  ZC3H14_S475A_vs_control = ZC3H14_S475A - control,
  ZC3H14_S475A_CDK13R860Q_vs_control = ZC3H14_S475A_CDK13R860Q - control,
  ZC3H14_S475E_vs_control = ZC3H14_S475E - control,
  siZC3H14_vs_siControl = siZC3H14 - siControl,
  siZFC3H1_vs_siControl = siZFC3H1 - siControl,
  levels = design
)
