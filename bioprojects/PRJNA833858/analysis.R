...
cm <- makeContrasts(
  SNK10.Icaritin_vs_DMSO = SNK.10.Icaritin - SNK.10.DMSO,
  SNT16.Icaritin_vs_DMSO = SNT.16.Icaritin - SNT.16.DMSO,
  SNT8.Icaritin_vs_DMSO= SNT.8.Icaritin - SNT.8.DMSO,
  levels = design
)
