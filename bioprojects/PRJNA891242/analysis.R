...
# Drop outlier sample
mae <- mae[, mae$BioSample != "SAMN31314194"]
...
cm <- makeContrasts(
  HT.0.2_uM_doxorubicin.24h_vs_HT.untreated.0h = HT.0.2_uM_doxorubicin.24h - HT.untreated.0h,
  OCILY19.0.2_uM_doxorubicin.24h_vs_OCILY19.untreated.0h = OCILY19.0.2_uM_doxorubicin.24h - OCILY19.untreated.0h,
  OCILY19.20nM_doxorubicin_removed_vs_OCILY19.untreated = OCILY19.20nM_doxorubicin_removed - OCILY19.untreated,
  OCILY3.0.2_uM_doxorubicin.24h_vs_OCILY3.untreated.0h = OCILY3.0.2_uM_doxorubicin.24h - OCILY3.untreated.0h,
  SUDHL5.0.2_uM_doxorubicin.24h_vs_SUDHL5.untreated.0h = SUDHL5.0.2_uM_doxorubicin.24h - SUDHL5.untreated.0h,
  levels = design
)
