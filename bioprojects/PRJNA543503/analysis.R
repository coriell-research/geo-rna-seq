...
cm <- makeContrasts(
  HCT116.tp53.mut4.1uM.doxorubicin.24hr_vs_tp53.mut4.untreated = HCT116.tp53..mut4.1uM.doxorubicin.24hr - HCT116.tp53..mut4.untreated.24hr,
  HCT116.tp53.mut4.1uM.doxorubicin.24hr_vs_tp53.non_mut.1uM.doxorubicin = HCT116.tp53..mut4.1uM.doxorubicin.24hr - HCT116.tp53..non_mut.1uM.doxorubicin.24hr,
  HCT116.tp53.mut4.1uM.doxorubicin.24hr_vs_tp53.non_mut.untreated = HCT116.tp53..mut4.1uM.doxorubicin.24hr - HCT116.tp53..non_mut.untreated.24hr,
  HCT116.tp53.mut5.1uM.doxorubicin.24hr_vs_tp53.mut5.untreated = HCT116.tp53..mut5.1uM.doxorubicin.24hr - HCT116.tp53..mut5.untreated.24hr,
  HCT116.tp53.mut5.1uM.doxorubicin.24hr_vs_tp53.non_mut.1uM.doxorubicin = HCT116.tp53..mut5.1uM.doxorubicin.24hr - HCT116.tp53..non_mut.1uM.doxorubicin.24hr,
  HCT116.tp53.mut5.1uM.doxorubicin.24hr_vs_tp53.non_mut.untreated = HCT116.tp53..mut5.1uM.doxorubicin.24hr - HCT116.tp53..non_mut.untreated.24hr, 
  HCT116.tp53.mut9.1uM.doxorubicin.24h_vs_tp53.mut9.untreated = HCT116.tp53..mut9.1uM.doxorubicin.24hr - HCT116.tp53..mut9.untreated.24hr, 
  HCT116.tp53.mut9.1uM.doxorubicin.24h_vs_tp53.non_mut.1uM.doxorubicin = HCT116.tp53..mut9.1uM.doxorubicin.24hr - HCT116.tp53..non_mut.1uM.doxorubicin.24hr,
  HCT116.tp53.mut9.1uM.doxorubicin.24h_vs_tp53.non_mut.untreated = HCT116.tp53..mut9.1uM.doxorubicin.24hr - HCT116.tp53..non_mut.untreated.24hr,
  levels = design
)
