...
cm <- makeContrasts(
  JJN3.Amiloride.0.4.mM.24h_vs_DMSO = JJN3.Amiloride.0.4.mM.24h - JJN3.Untreated..DMSO.,
  JJN3.TG003.0.4.mM.24h_vs_DMSO = JJN3.TG003.0.4.mM.24h - JJN3.Untreated..DMSO.,
  KMS.12.Amiloride.0.1.mM.24h_vs_DMSO = KMS.12.Amiloride.0.1.mM.24h - KMS.12.Untreated..DMSO.,
  KMS.12.TG003.0.4.mM.24h_vs_DMSO = KMS.12.TG003.0.4.mM.24h - KMS.12.Untreated..DMSO.,
