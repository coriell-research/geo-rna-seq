...
cm <- makeContrasts(
  JJN3.5.AZA_vs_JJN3.Control_4hr = JJN3.5.AZA.4hr - JJN3.Control.4hr,
  JJN3.5.AZA_vs_JJN3.Control_24hr = (JJN3.5.AZA.24hr - JJN3.5.AZA.4hr) - (JJN3.Control.24hr - JJN3.Control.4hr),
  JJN3.Combo_vs_JJN3.Control_4hr = JJN3.Combo.4hr - JJN3.Control.4hr,
  JJN3.Combo_vs_JJN3.Control_24hr = (JJN3.Combo.24hr - JJN3.Combo.4hr) - (JJN3.Control.24hr - JJN3.Control.4hr),
  JJN3.LBH.589_vs_JJN3.Control_4hr = JJN3.LBH.589.4hr - JJN3.Control.4hr,
  JJN3.LBH.589_vs_JJN3.Control_24hr = (JJN3.LBH.589.24hr - JJN3.LBH.589.4hr) - (JJN3.Control.24hr - JJN3.Control.4hr),
  U266.5.AZA_vs_U266.Control_4hr = U266.5.AZA.4hr - U266.Control.4hr,
  U266.5.AZA_vs_U266.Control_24hr = (U266.5.AZA.24hr - U266.5.AZA.4hr) - (U266.Control.24hr - U266.Control.4hr),
  U266.Combo_vs_U266.Control_4hr = U266.Combo.4hr - U266.Control.4hr,
  U266.Combo_vs_U266.Control_24hr = (U266.Combo.24hr - U266.Combo.4hr) - (U266.Control.24hr - U266.Control.4hr),
  U266.LBH.589_vs_U266.Control_4hr = U266.LBH.589.4hr - U266.Control.4hr,
  U266.LBH.589_vs_U266.Control_24hr = (U266.LBH.589.24hr - U266.LBH.589.4hr) - (U266.Control.24hr - U266.Control.4hr),
  levels = design
)
...
plot_boxplot(lcpm, y$samples, fillBy = "group", rle = TRUE) + labs(y = "RLE") + theme_coriell()
dev.off()

png(here(WD, "results", "figures", "logCPM-density.png"), width = 11, height = 7, units = "in", res = 150)
plot_density(lcpm, y$samples, colBy = "group") + labs(x = "logCPM") + theme_coriell()
dev.off()

pca.res <- pca(lcpm, y$sample)
png(here(WD, "results", "figures", "pca-biplot.png"), width = 8, height = 6, units = "in", res = 150)
biplot(pca.res, colby = "group", legendPosition = "bottom", lab = NULL)
dev.off()
