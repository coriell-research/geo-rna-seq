...
cm <- makeContrasts(
  SUM159.JQ1.100nM_vs_DMSO = SUM159.JQ1.100nM - SUM159.DMSO,
  SUM159.JQ1.100nM.paclitaxel.0.6nM_vs_DMSO = SUM159.JQ1.paclitaxel.100nM..0.6nM - SUM159.DMSO, 
  SUM159.JQ1.100nM.palbociclib.160nM_vs_DMSO = SUM159.JQ1.palbociclib.100nM..160nM - SUM159.DMSO,
  SUM159.paclitaxel.0.6nM_vs_DMSO= SUM159.paclitaxel.0.6nM - SUM159.DMSO, 
  SUM159.palbociclib.160nM_vs_DMSO = SUM159.palbociclib.160nM - SUM159.DMSO, 
  SUM159.DMSO_vs_SUM159.pre.treatment = SUM159.DMSO - SUM159.pre.treatment, 
