...
cm <- makeContrasts(
  MHCC97L.oxaliplatin_vs_untreated = MHCC97L.oxaliplatin - MHCC97L.none,
  MHCC97L.saracatinib_vs_untreated = MHCC97L.saracatinib - MHCC97L.none, 
  levels = design
)
