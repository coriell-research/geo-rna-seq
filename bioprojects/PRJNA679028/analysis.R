...
cm <- makeContrasts(
  T_ALL.Jurkat_cells.BSJ_4_23_vs_T_ALL.Jurkat_cells.BSJ_4_23NC = T_ALL.Jurkat_cells.BSJ_4_23 - T_ALL.Jurkat_cells.BSJ_4_23NC,
  T_ALL.Jurkat_cells.THZ531_vs_T_ALL.Jurkat_cells.DMSO = T_ALL.Jurkat_cells.THZ531 - T_ALL.Jurkat_cells.DMSO,
  T_ALL.Jurkat_cells.BSJ_4_23NC_vs_T_ALL.Jurkat_cells.DMSO = T_ALL.Jurkat_cells.BSJ_4_23NC - T_ALL.Jurkat_cells.DMSO,
  levels = design
)
