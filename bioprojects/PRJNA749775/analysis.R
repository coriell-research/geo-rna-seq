...
cm <- makeContrasts(
  MCF7.negative.cntrl.siRNA.Doxorubicin_vs_negative.cntrl.siRNA.Vehicle.H2O = MCF7.negative.cntrl.siRNA.Doxorubicin - MCF7.negative.cntrl.siRNA.Vehicle..H2O.,
  MCF7.siRNA.against.HuR.Doxorubicin_vs_siHuR.Vehicle.H2O= MCF7.siRNA.against.HuR.Doxorubicin - MCF7.siRNA.against.HuR.Vehicle..H2O.,
  MCF7.siRNA.against.HuR.Vehicle.H2O_vs_negative.cntrl.siRNA.Vehicle.H2O = MCF7.siRNA.against.HuR.Vehicle..H2O. - MCF7.negative.cntrl.siRNA.Vehicle..H2O.,
  MCF7.siRNA.against.HuR.Doxorubicin_vs_negative.cntrl.siRNA.Vehicle.H2O= MCF7.siRNA.against.HuR.Doxorubicin - MCF7.negative.cntrl.siRNA.Vehicle..H2O.,
