...
cm <- makeContrasts(
  KG1.ASLAN003_vs_KG1.DMSO = KG1.ASLAN003 - KG1.DMSO,
  MOLM14.ASLAN003_vs_MOLM14.DMSO = MOLM14.ASLAN003 - MOLM14.DMSO,
  ASLAN003_vs_DMSO = (KG1.ASLAN003 + MOLM14.ASLAN003) / 2 - (KG1.DMSO + MOLM14.DMSO) / 2,
levels = design
)
