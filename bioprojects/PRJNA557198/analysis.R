...
cm <- makeContrasts(
  EHEB.Flud_50uM.96h_vs_EHEB.DMSO.96h = EHEB.Flud_50uM.96h - EHEB.DMSO.96h,
  EHEB.Ibru_5uM.96h_vs_EHEB.DMSO.96h = EHEB.Ibru_5uM.96h - EHEB.DMSO.96h,
  EHEB.Idel_10uM.96h_vs_EHEB.DMSO.96h= EHEB.Idel_10uM.96h - EHEB.DMSO.96h,
  JVM2.Flud_50uM.72h_vs_JVM2.DMSO.72h = JVM2.Flud_50uM.72h - JVM2.DMSO.72h,
  JVM2.Ibru_5uM.72h_vs_JVM2.DMSO.72h = JVM2.Ibru_5uM.72h - JVM2.DMSO.72h,
  JVM2.Idel_10uM.72h_vs_JVM2.DMSO.72h = JVM2.Idel_10uM.72h - JVM2.DMSO.72h,
  EC1.Flud_50uM.48h_vs_MEC1.DMSO.48h = MEC1.Flud_50uM.48h - MEC1.DMSO.48h,
  MEC1.Ibru_5uM.48h_vs_MEC1.DMSO.48h = MEC1.Ibru_5uM.48h - MEC1.DMSO.48h,
  MEC1.Idel_10uM.48h_vs_MEC1.DMSO.48h = MEC1.Idel_10uM.48h - MEC1.DMSO.48h,
  levels = design
)
