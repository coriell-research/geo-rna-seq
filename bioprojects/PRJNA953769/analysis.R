...
cm <- makeContrasts(
  MCF7.100nM.Doxo.96hr_vs_Control = MCF7.100nM.Doxo.4day - MCF7.Control,
  MCF7.1uM.Palbociclib.96hr_vs_Control = MCF7.1uM.Palbociclib.4day - MCF7.Control, 
  MCF7.5uM.Cisplatin.96hr_vs_Control = MCF7.5uM.Cisplatin.4day - MCF7.Control,
  levels = design
)
