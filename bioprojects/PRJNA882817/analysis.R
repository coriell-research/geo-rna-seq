...
cm <- makeContrasts(
  SUM190_DR.1uM.Doxorubicin.72hr_vs_DMSO = SUM190_DR.1uM.Doxorubicin.72hr - SUM190_DR.DMSO.72hr,
  SUM190_DR.350nM.Doxorubicin.72hr_vs_DMSO = SUM190_DR.350nM.Doxorubicin.72hr - SUM190_DR.DMSO.72hr,
  SUM190_Parental.10nM.Paclitaxel.72hr_vs_DMSO = SUM190_Parental.10nM.Paclitaxel.72hr - SUM190_Parental.DMSO.72hr, 
  SUM190_Parental.15uM.Ruxolitinib.72hr_vs_DMSO = SUM190_Parental.15uM.Ruxolitinib.72hr - SUM190_Parental.DMSO.72hr, 
  SUM190_Parental.2.5nM.Paclitaxel.72hr_vs_DMSO = SUM190_Parental.2.5nM.Paclitaxel.72hr - SUM190_Parental.DMSO.72hr, 
  SUM190_Parental.1uM.Doxorubicin.72hr_vs_DMSO = SUM190_Parental.1uM.Doxorubicin.72hr - SUM190_Parental.DMSO.72hr, 
  SUM190_Parental.65nM.Doxorubicin.72hr_vs_DMSO = SUM190_Parental.65nM.Doxorubicin.72hr - SUM190_Parental.DMSO.72hr, 
  SUM190_Parental.15nM.Ruxolitinib.2.5nM.Paclitaxel.72hr_vs_DMSO = SUM190_Parental.15nM.Ruxolitinib.2.5nM.Paclitaxel.72hr - SUM190_Parental.DMSO.72hr, 
  SUM190_PR.10nM.Paclitaxel.72hr_vs_DMSO = SUM190_PR.10nM.Paclitaxel.72hr - SUM190_PR.DMSO.72hr,
  SUM190_PR.15nM.Ruxolitinib.6.5nM.Paclitaxel.72hr_vs_DMSO.72hr = SUM190_PR.15nM.Ruxolitinib.6.5nM.Paclitaxel.72hr - SUM190_PR.DMSO.72hr,
  SUM190_PR.15uM.Ruxolitinib.72hr_vs_DMSO.72hr = SUM190_PR.15uM.Ruxolitinib.72hr - SUM190_PR.DMSO.72hr,
  SUM190_PR.6.5nM.Paclitaxel.72hr_vs_DMSO.72hr = SUM190_PR.6.5nM.Paclitaxel.72hr - SUM190_PR.DMSO.72hr,
