...
cm <- makeContrasts(
  Azacitidine_vs_Vehicle = Azacitidine - Vehicle,
  BAY1436032_vs_Vehicle = BAY1436032 - Vehicle,
  BAY1436032_Azacitidine_seq_vs_Vehicle = BAY1436032_Azacitidine_seq - Vehicle,
  BAY1436032_Azacitidine_sim_vs_Vehicle = BAY1436032_Azacitidine_sim - Vehicle,
  levels = design
)
