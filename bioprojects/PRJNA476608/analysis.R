...
cm <- makeContrasts(
  U2OS.HS1KO.Bortezomib10h_vs_U2OS.HS1KO.control = U2OS.HS1KO.Bortezomib10h - U2OS.HS1KO.control,
  U2OS.HS1KO.Bortezomib6h_vs_U2OS.HS1KO.control = U2OS.HS1KO.Bortezomib6h - U2OS.HS1KO.control,
  U2OS.HS1KO.HS_1h_42c_vs_U2OS.HS1KO.control = U2OS.HS1KO.HS_1h_42c - U2OS.HS1KO.control,
  U2OS.HS2KO.Bortezomib10h_vs_U2OS.HS2KO.control = U2OS.HS2KO.Bortezomib10h - U2OS.HS2KO.control, 
  U2OS.HS2KO.Bortezomib6h_vs_U2OS.HS2KO.control = U2OS.HS2KO.Bortezomib6h - U2OS.HS2KO.control,
  U2OS.HS2KO.HS_1h_42c_vs_U2OS.HS2KO.control = U2OS.HS2KO.HS_1h_42c - U2OS.HS2KO.control,
  U2OS.WT.Bortezomib10h_vs_U2OS.WT.control = U2OS.WT.Bortezomib10h - U2OS.WT.control,
  U2OS.WT.Bortezomib6h_vs_U2OS.WT.control = U2OS.WT.Bortezomib6h - U2OS.WT.control,
  U2OS.WT.HS_1h_42c_vs_U2OS.WT.control = U2OS.WT.HS_1h_42c - U2OS.WT.control, 
  levels = design
)
