...
cm <- makeContrasts(
  PANC1.5.Panobinostat_vs_PANC1.5.DMSO = PANC1.5.Panobinostat - PANC1.5.DMSO,
  PANC1.5.E64FC65__Panobinostat_vs_PANC1.5.DMSO = PANC1.5.E64FC65__Panobinostat - PANC1.5.DMSO,
  PANC1.5.E64FC65_vs_PANC1.5.DMSO = PANC1.5.E64FC65 - PANC1.5.DMSO, 
  PANC1.9.ATF3_shRNA_E64FC65__Panobinostat_vs_PANC1.9.ATF3_shRNA_DMSO = PANC1.9.ATF3_shRNA_E64FC65__Panobinostat - PANC1.9.ATF3_shRNA_DMSO,
  PANC1.9.Scramble_shRNA_E64FC26__Panobinostat_vs_PANC1.9.Scramble_shRNA_DMSO = PANC1.9.Scramble_shRNA_E64FC26__Panobinostat - PANC1.9.Scramble_shRNA_DMSO, 
  T98G.5.Panobinostat_vs_T98G.5.DMSO = T98G.5.Panobinostat - T98G.5.DMSO, 
  T98G.5.E64FC65__Panobinostat_vs_T98G.5.DMSO = T98G.5.E64FC65__Panobinostat - T98G.5.DMSO, 
  T98G.5.E64FC65_vs_T98G.5.DMSO = T98G.5.E64FC65 - T98G.5.DMSO, 
  levels = design
)
