...
cm <- makeContrasts(
  mock.vorinostat_vs_mock.DMSO.4hr = mock.vorinostat.4hr - mock.DMSO.4hr,
  mock.vorinostat_mock.DMSO.8hr = (mock.vorinostat.8hr - mock.vorinostat.4hr) - (mock.DMSO.8hr - mock.DMSO.4hr),
  mock.vorinostat_mock.DMSO.12hr = (mock.vorinostat.12hr - mock.vorinostat.4hr) - (mock.DMSO.12hr - mock.DMSO.4hr),
  siGLI1.vorinostat_vs_siGLI1.DMSO.4hr = siGLI1.vorinostat.4hr - siGLI1.DMSO.4hr,
  siGLI1.vorinostat_vs_siGLI1.DMSO.8hr = (siGLI1.vorinostat.8hr - siGLI1.vorinostat.4hr) - (siGLI1.DMSO.8hr - siGLI1.DMSO.4hr),
  siPSMD13.vorinostat_vs_siPSMD13.DMSO.8hr = siPSMD13.vorinostat.8hr - siPSMD13.DMSO.8hr,
  siPSMD13.vorinostat_vs_siPSMD13.DMSO.12hr = (siPSMD13.vorinostat.12hr - siPSMD13.vorinostat.8hr) - (siPSDM13.DMSO.12hr - siPSMD13.DMSO.8hr),
  levels = design
)
