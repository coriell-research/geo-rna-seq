...
cm <- makeContrasts(
  T.5H.FC.1.25.mM.Mithramycin.A.polym.nanoparticles_vs_DMSO = T.5H.FC.1.25.mM.Mithramycin.A.loaded.in.polymeric.nanoparticles - T.5H.FC.1.vehicle..DMSO.,
  T.5H.FC.1.25.mM.Mithramycin.A_vs_DMSO = T.5H.FC.1.25.mM.Mithramycin.A - T.5H.FC.1.vehicle..DMSO.,
  T.5H.FC.1.300.nM.EC.8042_vs_DMSO = T.5H.FC.1.300.nM.EC.8042 - T.5H.FC.1.vehicle..DMSO.,
  X143.B.100.nM.EC.8042_vs_DMSO = X143.B.100.nM.EC.8042 - X143.B.vehicle..DMSO.,
  levels = design
)
