...
cm <- makeContrasts(
  ES2.SRMS.kd.cispl.15uM.8hr_vs_SRMS.kd.PBS = ES.2.SRMS.knockdown.cisplatin.15uM.8hr - ES.2.SRMS.knockdown.PBS.15uM.8hr,
  ES2.WT.cisplatin.15uM.8hr_vs_WT.PBS = ES.2.WT.cisplatin.15uM.8hr - ES.2.WT.PBS.15uM.8hr,
  levels = design
)
