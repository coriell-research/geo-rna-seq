...
cm <- makeContrasts(
  YB5.Decitabine_Depsipeptide_vs_DMSO = dac_depsi - dmso,
  YB5.Decitabine_GSK343_vs_DMSO = dac_gsk343 - dmso,
  YB5.Decitabine_S2101_vs_DMSO = dac_s2101 - dmso,
  YB5.Decitabine_UNC0638_vs_DMSO = dac_unc0638 - dmso,
  YB5.Decitabine_vs_DMSO = dac - dmso,
  YB5.Depsipeptide_vs_DMSO = depsi - dmso,
  YB5.GSK343_vs_DMSO = gsk343 - dmso,
  YB5.S2101_vs_DMSO = s2101 - dmso,
  YB5.UNC0638_vs_DMSO = unc0638 - dmso,
  levels = design
)
