...
cm <- makeContrasts(
  RKO.fasting.medium.1.FBS.1g.L.glucose_vs_RKO.control.medium.10.FBS.4.5g.L.glucose = RKO.fasting.medium..1.FBS.1g.L.glucose. - RKO.control.medium..10.FBS.4.5g.L.glucose.,
