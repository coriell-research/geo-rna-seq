...
cm <- makeContrasts(
  MCF7.ARID1A.fulvestrant_vs_ARID1A.DMSO = ARID1A.fulvestrant - ARID1A.DMSO,
  MCF7.ARID1A.JQ1_vs_ARID1A.DMSO = ARID1A.JQ1 - ARID1A.DMSO,
  MCF7.ARID1A.tamoxifen_vs_ARID1A.DMSO = ARID1A.tamoxifen - ARID1A.DMSO,
  MCF7.PARENTAL.fulvestrant_vs_PARENTAL.DMSO = PARENTAL.fulvestrant - PARENTAL.DMSO,
  MCF7.PARENTAL.JQ1_vs_PARENTAL.DMSO = PARENTAL.JQ1 - PARENTAL.DMSO,
  MCF7.PARENTAL.tamoxifen_vs_PARENTAL.DMSO = PARENTAL.tamoxifen - PARENTAL.DMSO,
  MCF7.WT.fulvestrant_vs_WT.DMSO = WT.fulvestrant - WT.DMSO,
  MCF7.WT.JQ1_vs_WT.DMSO = WT.JQ1 - WT.DMSO,
  MCF7.WT.tamoxifen_vs_WT.DMSO = WT.tamoxifen - WT.DMSO,
  levels = design
)
