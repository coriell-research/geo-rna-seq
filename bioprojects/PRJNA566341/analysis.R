...
cm <- makeContrasts(
  CAL62.100nM.THZ531.6h_vs_DMSO.6h = CAL.62.100.nM.THZ531.6h - CAL.62.DMSO.6h,
  CAL62.400nM.THZ531.6h_vs_DMSO.6h = CAL.62.400.nM.THZ531.6h - CAL.62.DMSO.6h,
  levels = design
)
