...
cm <- makeContrasts(
  LN18.BLM.KO.temozolomide.olaparib_vs_WT.untreated = LN18.BLM.KO.temozolomide...olaparib - LN18.WT.untreated,
  LN18.BLM.KO.untreated_vs_WT.untreated = LN18.BLM.KO.untreated - LN18.WT.untreated,
  LN229.BLM.KO.temozolomide.olaparib_vs_WT.untreated = LN229.BLM.KO.temozolomide...olaparib - LN229.WT.untreated,
  LN229.BLM.KO.untreated_vs_WT.untreated = LN229.BLM.KO.untreated - LN229.WT.untreated,
