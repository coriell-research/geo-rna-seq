...
cm <- makeContrasts(
  DU145.24hTHZ1_vs_DU145.24hDMSO = DU145.24hTHZ1 - DU145.24hDMSO,
  LNCaP.24hTHZ1_vs_LNCaP.24hDMSO = LNCaP.24hTHZ1 - LNCaP.24hDMSO,
  LNCaP.DHT_vs_LNCaP.VEH = LNCaP.DHT - LNCaP.VEH,
  LNCaP.DHTsiCDK7_vs_LNCaP.VEH = LNCaP.DHTsiCDK7 - LNCaP.VEH,
  LNCaP.DHTsiMED1_vs_LNCaP.VEH = LNCaP.DHTsiMED1 - LNCaP.VEH,
  LNCaP.DHTsiNT_vs_LNCaP.VEH = LNCaP.DHTsiNT - LNCaP.VEH,
  LNCaP.DHTTHZ1_vs_LNCaP.VEH = LNCaP.DHTTHZ1 - LNCaP.VEH,
  VCaP.24hTHZ1_vs_VCaP.24hDMSO = VCaP.24hTHZ1 - VCaP.24hDMSO,
  VCaP.DHT_vs_VCaP.VEH = VCaP.DHT - VCaP.VEH,
  VCaP.DHTsiCDK7_vs_VCaP.VEH = VCaP.DHTsiCDK7 - VCaP.VEH,
  VCaP.DHTsiMED1_vs_VCaP.VEH = VCaP.DHTsiMED1 - VCaP.VEH,
  VCaP.DHTsiNT_vs_VCaP.VEH = VCaP.DHTsiNT - VCaP.VEH,
  VCaP.DHTTHZ1_vs_VCaP.VEH = VCaP.DHTTHZ1 - VCaP.VEH,
  levels = design
)
