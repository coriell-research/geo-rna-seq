...
cm <- makeContrasts(
  HCT116.P53.RPL3.KO.5nM.Act.D.24hr_vs_P53.RPL3.KO.vehicle.CTR = HCT116.P53.....RPL3.KO.5nM.Act.D.24h - HCT116.P53.....RPL3.KO.vehicle.CTR,
  HCT116.P53.5nM.Act.D.24h_vs_P53.vehicle.CTR = HCT116.P53....5nM.Act.D.24h - HCT116.P53....vehicle.CTR,
  levels = design
)
