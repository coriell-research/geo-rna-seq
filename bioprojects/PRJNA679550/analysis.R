...
cm <- makeContrasts(
  Capan2.50.uM.Etoposide.24hr_vs_untreated = Capan2.50.uM.Etoposide.24.hrs - Capan2.untreated,
  H661.40.uM.Etoposide.24hr_vs_untreated = H661.40.uM.Etoposide.24.hrs - H661.untreated,
  PC9.10.uM.Etoposide.24hr_vs_untreated = PC9.10.uM.Etoposide.24.hrs - PC9.untreated,
  levels = design
)
