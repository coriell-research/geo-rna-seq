...
mae <- mae[, !mae$BioSample %in% c("SAMN11978270", "SAMN11978271")]
...
cm <- makeContrasts(
  THP1.TET2_KO.IFNy_vs_TET2_KO.Control = TET2_KO.IFNy - TET2_KO.Control,
  THP1.WT.IFNy_vs_WT.Control = WT.IFNy - WT.Control,
  THP1.IFNy_vs_Control = ((TET2_KO.IFNy + WT.IFNy)) / 2 - ((TET2_KO.Control + WT.Control) / 2),
  levels = design
)
