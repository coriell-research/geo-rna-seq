...
# Add additional genotype label to analysis
mut <- ifelse(mae$genotype %like% "wildtype", "wt", "mt")
mae$group <- paste(mut, mae$group, sep = ".")
...
cm <- makeContrasts(
  wt.HKE3.TGF_alpha.15_vs_HKE3.Unstimulated.0 =  wt.HKE3.TGF_alpha.15 -  wt.HKE3.Unstimulated.0,
  wt.HKE3.TGF_alpha.30_vs_HKE3.Unstimulated.0 =  wt.HKE3.TGF_alpha.30 -  wt.HKE3.Unstimulated.0,
  wt.HKE3.TGF_alpha.60_vs_HKE3.Unstimulated.0 =  wt.HKE3.TGF_alpha.60 -  wt.HKE3.Unstimulated.0,
  wt.HKE3.TGF_alpha.90_vs_HKE3.Unstimulated.0 =  wt.HKE3.TGF_alpha.90 -  wt.HKE3.Unstimulated.0,
  wt.HKE3.TGF_alpha.120_vs_HKE3.Unstimulated.0 = wt.HKE3.TGF_alpha.120 - wt.HKE3.Unstimulated.0,
  
  mt.HKE3.TGF_alpha.15_vs_HKE3.Unstimulated.0 =  mt.HKE3.TGF_alpha.15 -  mt.HKE3.Unstimulated.0,
  mt.HKE3.TGF_alpha.30_vs_HKE3.Unstimulated.0 =  mt.HKE3.TGF_alpha.30 -  mt.HKE3.Unstimulated.0,
  mt.HKE3.TGF_alpha.60_vs_HKE3.Unstimulated.0 =  mt.HKE3.TGF_alpha.60 -  mt.HKE3.Unstimulated.0,
  mt.HKE3.TGF_alpha.90_vs_HKE3.Unstimulated.0 =  mt.HKE3.TGF_alpha.90 -  mt.HKE3.Unstimulated.0,
  mt.HKE3.TGF_alpha.120_vs_HKE3.Unstimulated.0 = mt.HKE3.TGF_alpha.120 - mt.HKE3.Unstimulated.0,
  levels = design
)
