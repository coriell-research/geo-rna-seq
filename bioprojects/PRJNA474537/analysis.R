...
cm <- makeContrasts(
  CC122_vs_DMSO_5hr = CC122.5 - DMSO.5,
  LEN_vs_DMSO_5hr = LEN.5 - DMSO.5,
  CC122_vs_DMSO_24hr = (CC122.24 - CC122.5) - (DMSO.24 - DMSO.5),
  LEN_vs_DMSO_24hr = (LEN.24 - LEN.5) - (DMSO.24 - DMSO.5),
  levels = design
)
