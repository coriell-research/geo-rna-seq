...
cm <- makeContrasts(
  MIAPaCa2.L.Gln.40uM.Gem.0.5uM.48hr_vs_L.Gln.40uM.48hr = MIA.PaCa.2..L.Gln.40mM..Gem.0.5.uM..48h - MIA.PaCa.2..L.Gln.40mM..Gem.0..48h,
  MIAPaCa2.L.Gln.2uM.Gem.0.5uM.48hr_vs_L.Gln.2mM.48hr = MIA.PaCa.2..L.Gln.2mM..Gem.0.5.uM..48h - MIA.PaCa.2..L.Gln.2mM..Gem.0..48h,
  levels = design
)
