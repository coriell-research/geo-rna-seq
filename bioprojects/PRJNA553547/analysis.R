...
metadata<- metadata[metadata$group %in% c("GBM2.Bmp4..100ng.ml..72hrs", "GBM2.Serum..FBS.10...72hrs","GBM2.Untreated.Control.72hrs"),]
...
cm <- makeContrasts(
  GBM2.Bmp4.100ng.ml.72hrs_vs_Untreated.Control = GBM2.Bmp4..100ng.ml..72hrs - GBM2.Untreated.Control.72hrs,
  GBM2.Bmp4.100ng.ml.72hrs_vs_Serum.FBS.10 = GBM2.Bmp4..100ng.ml..72hrs - GBM2.Serum..FBS.10...72hrs, 
