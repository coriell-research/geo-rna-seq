...
cm <- makeContrasts(
  HSV1_C646.4_vs_HSV1_DMSO.4 = HSV1_C646.4 - HSV1_DMSO.4,
  HSV1_EPZ6438.4_vs_HSV1_DMSO.4 = HSV1_EPZ6438.4 - HSV1_DMSO.4,
  HSV1.2_vs_HSV1.1 = HSV1.2 - HSV1.1,
  HSV1.4_vs_HSV.1 = HSV1.4 - HSV1.1,
  HSV1.8_vs_HSV.1 = HSV1.8 - HSV1.1,
  HSV1.24_vs_HSV.1 = HSV1.8 - HSV1.1,
  levels = design
)
