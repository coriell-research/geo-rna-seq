...
cm <- makeContrasts(
  HT29.AZ5576_170nM_DBK1154_10uM.2.25h_vs_HT29.Drosophila_si.DMSO =
    HT29.AZ5576_170nM_DBK1154_10uM.2.25h - HT29.Drosophila_si.DMSO,
  HT29.AZ5576_170nM.2h_vs_HT29.Drosophila_si.DMSO = 
    HT29.AZ5576_170nM.2h - HT29.Drosophila_si.DMSO,
  HT29.DBK1154_10uM.2.25h_vs_HT29.Drosophila_si.DMSO = 
    HT29.DBK1154_10uM.2.25h - HT29.Drosophila_si.DMSO,
  
  THP1.sglNTS6.LPS_1ugMl_1h_vs_THP1.sglNTS6.control = 
    THP1.sglNTS6.LPS_1ugMl_1h - THP1.sglNTS6.control,
  THP1.sglNTS6.LPS_1ugMl_2h_vs_THP1.sglNTS6.control = 
    THP1.sglNTS6.LPS_1ugMl_2h - THP1.sglNTS6.control,
  THP1.sglNTS6.LPS_1ugMl_4h_vs_THP1.sglNTS6.control =
    THP1.sglNTS6.LPS_1ugMl_4h - THP1.sglNTS6.control,
  THP1.sglNTS6.LPS_1ugMl_8h_vs_THP1.sglNTS6.control = 
    THP1.sglNTS6.LPS_1ugMl_8h - THP1.sglNTS6.control,
  
  THP1.sgSCR.LPS_1ugMl_1h_vs_THP1.sgSCR.control = 
    THP1.sgSCR.LPS_1ugMl_1h - THP1.sgSCR.control,
  THP1.sgSCR.LPS_1ugMl_2h_vs_THP1.sgSCR.control = 
    THP1.sgSCR.LPS_1ugMl_2h - THP1.sgSCR.control,
  THP1.sgSCR.LPS_1ugMl_4h_vs_THP1.sgSCR.control = 
    THP1.sgSCR.LPS_1ugMl_4h - THP1.sgSCR.control,
  THP1.sgSCR.LPS_1ugMl_8h_vs_THP1.sgSCR.control = 
    THP1.sgSCR.LPS_1ugMl_8h - THP1.sgSCR.control,
  levels = design
)
