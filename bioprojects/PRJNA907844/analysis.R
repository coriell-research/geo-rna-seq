...
cm <- makeContrasts(
  HS578T.chrom17p_KO.doxorubicin_vs_HS578T.chrom17p_KO.untreated = HS578T.chrom17p_KO.doxorubicin - HS578T.chrom17p_KO.untreated,
  HS578T.WT.doxorubicin_vs_HS578T.WT.untreated = HS578T.WT.doxorubicin - HS578T.WT.untreated,
  levels = design
)
