...
cm <- makeContrasts(
  CCRF_CEM.None.IL7_vs_CCRF_CEM.None.VEH_4hr = CCRF_CEM.None.IL7.4 - CCRF_CEM.None.VEH.,
  CCRF_CEM.None.DEX_vs_CCRF_CEM.None.VEH_4hr = CCRF_CEM.None.DEX.4 - CCRF_CEM.None.VEH.,
  CCRF_CEM.None.DEX_IL7_vs_CCRF_CEM.None.VEH_4hr = CCRF_CEM.None.DEX_IL7.4 - CCRF_CEM.None.VEH.,
  CCRF_CEM.None.IL7_vs_CCRF_CEM.None.VEH_16hr = CCRF_CEM.None.IL7.16 - CCRF_CEM.None.VEH.,
  CCRF_CEM.None.DEX_vs_CCRF_CEM.None.VEH_16hr = CCRF_CEM.None.DEX.16 - CCRF_CEM.None.VEH.,
  CCRF_CEM.None.DEX_IL7_vs_CCRF_CEM.None.VEH_16hr = CCRF_CEM.None.DEX_IL7.16 - CCRF_CEM.None.VEH.,
  CCRF_CEM.STAT5A_STAT5B.IL7_vs_CCRF_CEM.STAT5A_STAT5B.VEH_4hr = CCRF_CEM.STAT5A_STAT5B.IL7.4 - CCRF_CEM.STAT5A_STAT5B.VEH.,
  CCRF_CEM.STAT5A_STAT5B.DEX_vs_CCRF_CEM.STAT5A_STAT5B.VEH_4hr = CCRF_CEM.STAT5A_STAT5B.DEX.4 - CCRF_CEM.STAT5A_STAT5B.VEH.,
  CCRF_CEM.STAT5A_STAT5B.DEX_IL7_vs_CCRF_CEM.STAT5A_STAT5B.VEH_4hr = CCRF_CEM.STAT5A_STAT5B.DEX_IL7.4 - CCRF_CEM.STAT5A_STAT5B.VEH.,
  CCRF_CEM.STAT5A_STAT5B.IL7_vs_CCRF_CEM.STAT5A_STAT5B.VEH_16hr = CCRF_CEM.STAT5A_STAT5B.IL7.16 - CCRF_CEM.STAT5A_STAT5B.VEH.,
  CCRF_CEM.STAT5A_STAT5B.DEX_vs_CCRF_CEM.STAT5A_STAT5B.VEH_16hr = CCRF_CEM.STAT5A_STAT5B.DEX.16 - CCRF_CEM.STAT5A_STAT5B.VEH.,
  CCRF_CEM.STAT5A_STAT5B.DEX_IL7_vs_CCRF_CEM.STAT5A_STAT5B.VEH_16hr = CCRF_CEM.STAT5A_STAT5B.DEX_IL7.16 - CCRF_CEM.STAT5A_STAT5B.VEH.,
  levels = design
)
