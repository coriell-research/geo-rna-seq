...
cm <- makeContrasts(
  tumor_biopsy.resistant.BRAFi_vs_tumor_biopsy.sensitive.none = tumor_biopsy.resistant.BRAFi - tumor_biopsy.sensitive.none,
  tumor_biopsy.resistant.BRAFi_MEKi_vs_tumor_biopsy.sensitive.none = tumor_biopsy.resistant.BRAFi_MEKi - tumor_biopsy.sensitive.none,
  Melanoma_cell_line.resistant.BRAFi_vs_Melanoma_cell_line.sensitive.none = Melanoma_cell_line.resistant.BRAFi - Melanoma_cell_line.sensitive.none,
  Melanoma_cell_line.resistant.BRAFi_MEKi_vs_Melanoma_cell_line.sensitive.none = Melanoma_cell_line.resistant.BRAFi_MEKi - Melanoma_cell_line.sensitive.none,
  levels = design
)
