...
cm <- makeContrasts(
  x1013.palbociclib_TAK228_vs_x1013.vehicle_control = x1013.palbociclib_TAK228 - x1013.vehicle_control,
  x1013.palbociclib_vs_x1013.vehicle_control = x1013.palbociclib - x1013.vehicle_control,
  x1222.palbociclib_TAK228_vs_x1222.vehicle_control = x1222.palbociclib_TAK228 - x1222.vehicle_control,
  x1222.palbociclib_vs_x1222.vehicle_control = x1222.palbociclib - x1222.vehicle_control,
  x226.palbociclib_TAK228_vs_x226.vehicle_control = x226.palbociclib_TAK228 - x226.vehicle_control,
  x226.palbociclib_vs_x226.vehicle_control = x226.palbociclib - x226.vehicle_control,
  x3226.palbociclib_TAK228_vs_x3226.vehicle_control = x3226.palbociclib_TAK228 - x3226.vehicle_control,
  x3226.palbociclib_vs_x3226.vehicle_control = x3226.palbociclib - x3226.vehicle_control,
  x519.palbociclib_TAK228_vs_x519.vehicle_control = x519.palbociclib_TAK228 - x519.vehicle_control,
  x519.palbociclib_vs_x519.vehicle_control = x519.palbociclib - x519.vehicle_control,
  x810.palbociclib_TAK228_vs_x810.vehicle_control = x810.palbociclib_TAK228 - x810.vehicle_control,
  x810.palbociclib_vs_x810.vehicle_control = x810.palbociclib - x810.vehicle_control,
  x827.palbociclib_TAK228_vs_x827.vehicle_control = x827.palbociclib_TAK228 - x827.vehicle_control,
  x827.palbociclib_vs_x827.vehicle_control = x827.palbociclib - x827.vehicle_control,
  x828.palbociclib_TAK228_vs_x828.vehicle_control = x828.palbociclib_TAK228 - x828.vehicle_control,
  x828.palbociclib_vs_x828.vehicle_control = x828.palbociclib - x828.vehicle_control,
  x97.palbociclib_TAK228_vs_x97.vehicle_control = x97.palbociclib_TAK228 - x97.vehicle_control,
  x97.palbociclib_vs_x97.vehicle_control = x97.palbociclib - x97.vehicle_control,
  x99.palbociclib_TAK228_vs_x99.vehicle_control = x99.palbociclib_TAK228 - x99.vehicle_control,
  x99.palbociclib_vs_x99.vehicle_control = x99.palbociclib - x99.vehicle_control,
  levels = design
)
