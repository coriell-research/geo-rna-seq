...
mae <- mae[, colnames(mae) != "SRR1634333"]
...
cm <- makeContrasts(
  Decitabine_vs_Control = dac - control,
  Decitabine_siCHD4_vs_Control = dac_siCHD4 - control,
  siCHD4_vs_Control = siCHD4 - control,
  siDMNT1_vs_Control = siDMNT1 - control,
  siDNMT1_siCHD4_vs_Control = siDNMT1_siCHD4 - control,
  levels = design
)
