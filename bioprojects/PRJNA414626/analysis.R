...
cm <- makeContrasts(
  HCT116.120mins_TGFalpha_vs_HCT116.unstimulated = HCT116.120mins_TGFalpha - HCT116.unstimulated,
  HCT116.90mins_TGFalpha_vs_HCT116.unstimulated = HCT116.90mins_TGFalpha - HCT116.unstimulated,
  HCT116.60mins_TGFalpha_vs_HCT116.unstimulated = HCT116.60mins_TGFalpha - HCT116.unstimulated,
  HCT116.30mins_TGFalpha_vs_HCT116.unstimulated = HCT116.30mins_TGFalpha - HCT116.unstimulated,
  HCT116.15mins_TGFalpha_vs_HCT116.unstimulated = HCT116.15mins_TGFalpha - HCT116.unstimulated,
  HKE3.120mins_TGFalpha_vs_HKE3.unstimulated = HKE3.120mins_TGFalpha - HKE3.unstimulated, 
  HKE3.90mins_TGFalpha_vs_HKE3.unstimulated = HKE3.90mins_TGFalpha - HKE3.unstimulated,
  HKE3.60mins_TGFalpha_vs_HKE3.unstimulated = HKE3.60mins_TGFalpha - HKE3.unstimulated,
  HKE3.30mins_TGFalpha_vs_HKE3.unstimulated = HKE3.30mins_TGFalpha - HKE3.unstimulated,
  HKE3.15mins_TGFalpha_vs_HKE3.unstimulated = HKE3.15mins_TGFalpha - HKE3.unstimulated, 
  levels = design
)
