...
cm <- makeContrasts(
  HCC1806.LB.96hr_vs_HCC1806.DMSO.96hr = HCC1806.LB.96hr - HCC1806.DMSO.96hr, 
  HCC1806.LB.4w_vs_HCC1806.DMSO.4w = HCC1806.LB.4w - HCC1806.DMSO.4w,
  MDAMB231.LB.96hr_vs_MDAMB231.DMSO.96hr = MDAMB231.LB.96hr - MDAMB231.DMSO.96hr, 
  MDAMB231.LB.4w_vs_MDAMB231.DMSO.4w = MDAMB231.LB.4w - MDAMB231.DMSO.4w,
  levels = design
)
