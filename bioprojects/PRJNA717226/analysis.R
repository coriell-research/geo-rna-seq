...
#make edits to wrong annotations 
metadata[grepl("Baseline", group), group := gsub("Baseline.Untreated", "Untreated", group)]
metadata[grepl("Untreated.Untreated", group), group := gsub("Untreated.Untreated", "Untreated", group)] 
