...
cm <- makeContrasts(
  NCIH1299.BRM011.6h_vs_NCIH1299.DMSO.6h = NCIH1299.BRM011.6h - NCIH1299.DMSO.6h,
  NCIH1299.BRM011.16h_vs_NCIH1299.DMSO.16h = (NCIH1299.BRM011.16h - NCIH1299.BRM011.6h) - (NCIH1299.DMSO.16h - NCIH1299.DMSO.6h),
  NCIH1299.dox.48h_vs_NCIH1299.NTC.48h = NCIH1299.dox.48h - NCIH1299.NTC.48h,
  NCIH1299.sh5537_dox.48h_vs_NCIH1299.NTC.48h = NCIH1299.sh5537_dox.48h - NCIH1299.NTC.48h,
  NCIH1299.sh2025_dox.48h_vs_NCIH1299.NTC.48h = NCIH1299.sh2025_dox.48h - NCIH1299.NTC.48h,
  NCIH1299.dox.72h_vs_NCIH1299.NTC.72h = (NCIH1299.dox.72h - NCIH1299.dox.48h) - (NCIH1299.NTC.72h - NCIH1299.NTC.48h),
  NCIH1299.sh5537_dox.72h_vs_NCIH1299.NTC.72h = (NCIH1299.sh5537_dox.72h - NCIH1299.sh5537_dox.48h) - (NCIH1299.NTC.72h - NCIH1299.NTC.48h),
  NCIH1299.sh2025_dox.72h_vs_NCIH1299.NTC.72h = (NCIH1299.sh2025_dox.72h - NCIH1299.sh2025_dox.48h) - (NCIH1299.NTC.72h - NCIH1299.NTC.48h),
  levels = design
)
