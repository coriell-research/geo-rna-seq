...
cm <- makeContrasts(
  MCF7.Decitabine_vs_DMSO = dac - dmso,
  MCF7.Decitabine_Depsipeptide_vs_DMSO = dac_depsi - dmso,
  MCF7.Decitabine_GSK343_vs_DMSO = dac_gsk343 - dmso,
  MCF7.Decitabine_S2101_vs_DMSO = dac_s2101 - dmso,
  MCF7.Decitabine_UNC0638_vs_DMSO = dac_unc0638 - dmso,
  MCF7.Depsipeptide_vs_DMSO = depsi - dmso,
  MCF7.GSK343_vs_DMSO = gsk343 - dmso,
  MCF7.S2101_vs_DMSO = s2101 - dmso,
  MCF7.UNC0638_vs_DMSO = unc0638 - dmso,
  levels = design
)
