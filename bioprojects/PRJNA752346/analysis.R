...
cm <- makeContrasts(
  hiPSC_cardiomyocytes.RARGWT_S427L.1uM.doxorubicin_vs_hiPSC_cardiomyocytes.RARGWT_S427L.DMSO =
    hiPSC_cardiomyocytes.RARGWT_S427L.1uM.doxorubicin - hiPSC_cardiomyocytes.RARGWT_S427L.DMSO,
  hiPSC_cardiomyocytes.RARGWT_WT.1uM.doxorubicin_vs_hiPSC_cardiomyocytes.RARGWT_WT.DMSO = 
    hiPSC_cardiomyocytes.RARGWT_WT.1uM.doxorubicin - hiPSC_cardiomyocytes.RARGWT_WT.DMSO,
  levels = design
)
