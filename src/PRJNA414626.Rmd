...
```{r}
if (!dir.exists(here("results", "PRJNA414626"))) {
  dir.create(here("results", "PRJNA414626", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA414626", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA414626", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA414626", "rds-files", "se.rds"))
```
