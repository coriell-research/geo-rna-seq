...
```{r}
if (!dir.exists(here("results", "PRJNA298594"))) {
  dir.create(here("results", "PRJNA298594", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA298594", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA298594", "rds-files", "se.rds"))
```
