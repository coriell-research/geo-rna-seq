...
```{r}
if (!dir.exists(here("results", "PRJNA578935"))) {
  dir.create(here("results", "PRJNA578935", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA578935", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA578935", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA578935", "rds-files", "se.rds"))
```
