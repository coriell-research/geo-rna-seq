...
```{r}
if (!dir.exists(here("results", "PRJNA636096"))) {
  dir.create(here("results", "PRJNA636096", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA636096", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA636096", "rds-files", "se.rds"))
```
