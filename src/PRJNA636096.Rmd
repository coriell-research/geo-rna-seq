...
contrast.matrix <- makeContrasts(
  MCC.5637 = MCC.5637 - NT.5637,
  MCC.CLS_439 = MCC.CLS_439 - NT.CLS_439,
  MCC.T24 = MCC.T24 - NT.T24,
  MCC.TCC_SUP = MCC.TCC_SUP - NT.TCC_SUP,
  
  MCC = ((MCC.5637 + MCC.CLS_439 + MCC.T24 + MCC.TCC_SUP) / 4) - 
...
names(cons) <- cons
titles <- c("MCC vs No Treatment - 5637 Cells",
            "MCC vs No Treatment - CLS-439 Cells",
            "MCC vs No Treatment - T24 Cells",
            "MCC vs No Treatment - TCC-Supp Cells",
            "MCC vs No Treatment")
