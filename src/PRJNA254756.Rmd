...
```{r}
if (!dir.exists(here("results", "PRJNA254756"))) {
  dir.create(here("results", "PRJNA254756", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA254756", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA254756", "rds-files", "se.rds"))
```
