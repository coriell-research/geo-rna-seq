...
```{r}
if (!dir.exists(here("results", "PRJNA596223"))) {
  dir.create(here("results", "PRJNA596223", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA596223", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA596223", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA596223", "rds-files", "se.rds"))
```
