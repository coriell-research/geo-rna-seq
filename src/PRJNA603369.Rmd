...
se <- readRDS(here("data", "PRJNA603369", "summarized_experiment.rds"))
```
...
contrast.matrix <- makeContrasts(
  kasumi.abbv075.100nM = kasumi.abbv075.100nM - kasumi.dmso,
  kasumi.abbv744.200nM = kasumi.abbv744.200nM - kasumi.dmso,
  mv411.abbv075.100nM = mv411.abbv075.100nM - mv411.dmso,
  mv411.abbv744.200nM = mv411.abbv744.200nM - mv411.dmso,
  nci_h1299.abbv075.100nM = nci_h1299.abbv075.100nM - nci_h1299.dmso,
  nci_h1299.abbv744.200nM = nci_h1299.abbv744.200nM - nci_h1299.dmso,
  skm.abbv075.100nM = skm.abbv075.100nM - skm.dmso,
  skm.abbv744.200nM = skm.abbv744.200nM - skm.dmso,
  
  abbv075.100nM = ((kasumi.abbv075.100nM + mv411.abbv075.100nM + nci_h1299.abbv075.100nM + skm.abbv075.100nM) / 4) - 
                  ((kasumi.dmso + mv411.dmso + nci_h1299.dmso + skm.dmso) / 4),
  abbv744.200nM = ((kasumi.abbv744.200nM + mv411.abbv744.200nM + nci_h1299.abbv744.200nM + skm.abbv744.200nM) / 4) -
                  ((kasumi.dmso + mv411.dmso + nci_h1299.dmso + skm.dmso) / 4),
...
names(cons) <- cons
titles <- c("ABBV-075 100nM vs DMSO - Kasumi Cells",
            "ABVV-744 20nM vs DMSO - Kasumi Cells",
            "ABBV-075 100nM vs DMSO - MV-4-11 Cells",
            "ABBV-0744 200nM vs DMSO - MV-4-11 Cells",
            "ABBV-075 100nM vs DMSO - NCI-H1299 Cells",
            "ABBV-744 200nM vs DMSO - NCI-H1299 Cells",
            "ABBV-075 100nM vs DMSO - SKM Cells",
            "ABBV-744 200nM vs DMSO - SKM Cells",
            "ABBV-075 100nM vs DMSO",
            "ABBV-744 200nM vs DMSO")
...
dge <- df %>% 
  ...
  write_tsv(here("results", "PRJNA603369", "data-files", "dge.tsv"))

dre <- df %>% 
  filter(!feature_id %in% cds$gene_name) %>% 
  write_tsv(here("results", "PRJNA603369", "data-files", "dre.tsv"))
```
...
write_rds(lcpms.gene, here("results", "PRJNA603369", "rds-files", "gene-lcpms.rds"))
write_rds(lcpms.re, here("results", "PRJNA603369", "rds-files", "re-lcpms.rds"))
```
