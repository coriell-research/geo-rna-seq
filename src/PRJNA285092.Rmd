...
```{r}
if (!dir.exists(here("results", "PRJNA285092"))) {
  dir.create(here("results", "PRJNA285092", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA285092", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA285092", "rds-files", "se.rds"))
```
