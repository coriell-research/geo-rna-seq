...
contrast.matrix <- makeContrasts(
  CAR.Raij = CAR.Raij - CAR.control,
  Till_CAR.dac_14d_vs_7d = Till_CAR.dac_14d - Till_CAR.dac_7d,
  Till_dCAR.dac_14d_vs_7d = Till_dCAR.dac_14d - Till_dCAR.dac_7d,
  dCAR.dac_Raij_vs_dac = dCAR.dac_Raij - dCAR.dac,
  levels = design
)
...
names(cons) <- cons
titles <- c("CAR Raij vs Control",
            "Till CAR + DAC 14d vs 7d",
            "Till dCAR + DAC 14d vs 7d",
            "dCAR DAC + Raij vs DAC")
