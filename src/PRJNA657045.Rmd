...
fwrite(
  ...
  file = here("results", "PRJNA657045", "data-files", "dge.tsv"),
  sep = "\t"
  )

fwrite(
  x = df[!feature_id %chin% cds$gene_name],
  file = here("results", "PRJNA657045", "data-files", "dre.tsv"),
  sep = "\t"
)
```
...
saveRDS(lcpms.gene, here("results", "PRJNA657045", "rds-files", "gene-lcpms.rds"))
saveRDS(lcpms.re, here("results", "PRJNA657045", "rds-files", "re-lcpms.rds"))
```

## Save design and contrast matrix

```{r}
saveRDS(design, here("results", "PRJNA657045", "rds-files", "design.rds"))
saveRDS(contrast.matrix, here("results", "PRJNA657045", "rds-files", "contrast-matrix.rds"))
```
...
fviz_eig(pca.gene, addlabels = TRUE) +
  ...
  ggsave(here("results", "PRJNA657045", "figures", "gene-scree.png"),
         width = 8,
         height = 5)

fviz_eig(pca.re, addlabels = TRUE) +
  ggtitle("Repetitive Elements") +
  ggsave(here("results", "PRJNA657045", "figures", "re-scree.png"),
         width = 8,
         height = 5)
...
ind.gene$coord %>% 
  ...
  theme_light() +
  ggsave(here("results", "PRJNA657045", "figures", "gene-pca.png"),
         width = 8,
         height = 5)
# REs
ind.re$coord %>% 
  ...
  scale_color_brewer(palette = "Dark2") +
  theme_light() +
  ggsave(here("results", "PRJNA657045", "figures", "re-pca.png"),
         width = 8,
         height = 5)
```
...
quickmap(lcpms.sig_genes, 
         ...
         filename = here("results", "PRJNA657045", "figures", "gene-heatmap.png"))

quickmap(lcpms.sig_res, 
         annotation_col = col_df,
         annotation_colors = ann_colors,
         main = paste("Significant (FDR <", sig, ") Repetitive Elements"),
         filename = here("results", "PRJNA657045", "figures", "re-heatmap.png"))
```
...
ggsave(here("results", "PRJNA657045", "figures", "gene-vplots.png"),
       width = 18,
       height = 10)
...
(gene_mdplots[[3]] + scale_y_continuous(limits = c(-10, 10)) |
 ...
 plot_layout(guides = "collect") +
 plot_annotation("Protein Coding Gene Expression") +
ggsave(here("results", "PRJNA657045", "figures", "gene-mdplots.png"),
       width = 18,
       height = 10)

# RE
(re_vplots[[1]] + scale_y_continuous(limits = c(0, 2)) + scale_x_continuous(limits = c(-8, 8)) |
 re_vplots[[2]] + scale_y_continuous(limits = c(0, 2)) + scale_x_continuous(limits = c(-8, 8)) ) /
(re_vplots[[3]] + scale_y_continuous(limits = c(0, 2)) + scale_x_continuous(limits = c(-8, 8)) |
 re_vplots[[4]] + scale_y_continuous(limits = c(0, 2)) + scale_x_continuous(limits = c(-8, 8))) +
 plot_layout(guides = "collect") +
 plot_annotation("RE Expression") +
ggsave(here("results", "PRJNA657045", "figures", "re-vplots.png"),
       width = 18,
       height = 10)
...
(re_mdplots[[3]] + scale_y_continuous(limits = c(-8, 8)) |
 ...
 plot_layout(guides = "collect") +
 plot_annotation("RE Expression") +
ggsave(here("results", "PRJNA657045", "figures", "re-mdplots.png"),
       width = 18,
       height = 10)
```
...
(dotplots[[1]] | dotplots[[2]] | dotplots[[3]] ) +
plot_annotation("RE Family Expression") +
ggsave(here("results", "PRJNA657045", "figures", "dotplots.png"),
       width = 18,
       height = 7)
```
