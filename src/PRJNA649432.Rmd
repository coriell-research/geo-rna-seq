...
```{r}
if (!dir.exists(here("results", "PRJNA649432"))) {
  dir.create(here("results", "PRJNA649432", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA649432", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA649432", "rds-files", "se.rds"))
```
