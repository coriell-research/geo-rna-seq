...
```{r}
if (!dir.exists(here("results", "PRJNA907844"))) {
  dir.create(here("results", "PRJNA907844", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA907844", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA907844", "MultiAssayExperiment.rds"))
```
...
contrast.matrix <- makeContrasts(
  HS578T.chrom17p_KO.doxorubicin_vs_HS578T.chrom17p_KO.untreated = 
    HS578T.chrom17p_KO.doxorubicin - HS578T.chrom17p_KO.untreated,
...
saveRDS(se, here("results", "PRJNA907844", "rds-files", "se.rds"))
```
