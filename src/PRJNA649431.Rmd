...
```{r}
if (!dir.exists(here("results", "PRJNA649431"))) {
  dir.create(here("results", "PRJNA649431", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA649431", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA649431", "rds-files", "se.rds"))
```
