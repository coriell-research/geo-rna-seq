...
contrast.matrix <- makeContrasts(
  PDX_TALL1.dac = PDX_TALL1.dac - PDX_TALL1.dmso,
  PDX_TALL2.dac = PDX_TALL2.dac - PDX_TALL2.dmso,
  dac = ((PDX_TALL1.dac + PDX_TALL2.dac) / 2) - ((PDX_TALL1.dmso + PDX_TALL2.dmso) / 2),
  levels = design
)
...
names(cons) <- cons
titles <- c("PDX_TALL1 DAC vs DMSO",
            "PDX_TALL2 DAC vs DMSO",
            "DAC vs DMSO")
