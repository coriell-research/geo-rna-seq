...
```{r}
if (!dir.exists(here("results", "PRJNA642730"))) {
  dir.create(here("results", "PRJNA642730", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA642730", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA642730", "rds-files", "se.rds"))
```
