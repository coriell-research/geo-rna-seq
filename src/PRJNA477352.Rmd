...
```{r}
if (!dir.exists(here("results", "PRJNA477352"))) {
  dir.create(here("results", "PRJNA477352", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA477352", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA477352", "rds-files", "se.rds"))
```
