...
```{r}
if (!dir.exists(here("results", "PRJNA517432"))) {
  dir.create(here("results", "PRJNA517432", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA517432", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA517432", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA517432", "rds-files", "se.rds"))
```
