...
```{r}
if (!dir.exists(here("results", "PRJNA395584"))) {
  dir.create(here("results", "PRJNA395584", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA395584", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA395584", "rds-files", "se.rds"))
```
