...
```{r}
if (!dir.exists(here("results", "PRJNA296593"))) {
  dir.create(here("results", "PRJNA296593", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA296593", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA296593", "rds-files", "se.rds"))
```
