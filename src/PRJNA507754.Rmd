...
```{r}
if (!dir.exists(here("results", "PRJNA507754"))) {
  dir.create(here("results", "PRJNA507754", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA507754", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA507754", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA507754", "rds-files", "se.rds"))
```
