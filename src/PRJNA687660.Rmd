...
```{r}
if (!dir.exists(here("results", "PRJNA687660"))) {
  dir.create(here("results", "PRJNA687660", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA687660", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA687660", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA687660", "rds-files", "se.rds"))
```
