...
```{r}
if (!dir.exists(here("results", "PRJNA434191"))) {
  dir.create(here("results", "PRJNA434191", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA434191", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA434191", "MultiAssayExperiment.rds"))
```
...
contrast.matrix <- makeContrasts(
  HKE3.TGF_alpha.15_vs_HKE3.Unstimulated.0 = HKE3.TGF_alpha.15 - HKE3.Unstimulated.0,
  HKE3.TGF_alpha.30_vs_HKE3.Unstimulated.0 = HKE3.TGF_alpha.30 - HKE3.Unstimulated.0,
  HKE3.TGF_alpha.60_vs_HKE3.Unstimulated.0 = HKE3.TGF_alpha.60 - HKE3.Unstimulated.0,
  HKE3.TGF_alpha.90_vs_HKE3.Unstimulated.0 = HKE3.TGF_alpha.90 - HKE3.Unstimulated.0,
  HKE3.TGF_alpha.120_vs_HKE3.Unstimulated.0 = HKE3.TGF_alpha.120 - HKE3.Unstimulated.0,
  levels = design
)
...
saveRDS(se, here("results", "PRJNA434191", "rds-files", "se.rds"))
```
