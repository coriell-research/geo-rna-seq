...
```{r}
if (!dir.exists(here("results", "PRJNA260377"))) {
  dir.create(here("results", "PRJNA260377", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA260377", "data-files"))
}
```
...
Only one sample in this group

```{r}
mae <- mae[, mae$BioSample != "SAMN03020545"]
```
...
saveRDS(se, here("results", "PRJNA260377", "rds-files", "se.rds"))
```
