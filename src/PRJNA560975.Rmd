...
```{r}
if (!dir.exists(here("results", "PRJNA560975"))) {
  dir.create(here("results", "PRJNA560975", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA560975", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA560975", "rds-files", "se.rds"))
```
