...
```{r}
if (!dir.exists(here("results", "PRJNA679028"))) {
  dir.create(here("results", "PRJNA679028", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA679028", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA679028", "MultiAssayExperiment.rds"))
```
...
contrast.matrix <- makeContrasts(
  T_ALL.Jurkat_cells.BSJ_4_23_vs_T_ALL.Jurkat_cells.DMSO = T_ALL.Jurkat_cells.BSJ_4_23 - T_ALL.Jurkat_cells.DMSO,
...
saveRDS(se, here("results", "PRJNA679028", "rds-files", "se.rds"))
```
