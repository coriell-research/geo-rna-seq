...
```{r}
if (!dir.exists(here("results", "PRJNA358776"))) {
  dir.create(here("results", "PRJNA358776", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA358776", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA358776", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA358776", "rds-files", "se.rds"))
```
