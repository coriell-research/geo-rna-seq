...
```{r}
if (!dir.exists(here("results", "PRJNA554700"))) {
  dir.create(here("results", "PRJNA554700", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA554700", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA554700", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA554700", "rds-files", "se.rds"))
```
