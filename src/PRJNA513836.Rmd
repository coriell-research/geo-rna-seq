...
```{r}
if (!dir.exists(here("results", "PRJNA513836"))) {
  dir.create(here("results", "PRJNA513836", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA513836", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA513836", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA513836", "rds-files", "se.rds"))
```
