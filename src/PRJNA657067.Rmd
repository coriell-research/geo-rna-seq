...
```{r}
if (!dir.exists(here("results", "PRJNA657067"))) {
  dir.create(here("results", "PRJNA657067", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA657067", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA657067", "rds-files", "se.rds"))
```
