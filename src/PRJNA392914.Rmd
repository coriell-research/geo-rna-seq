...
```{r}
if (!dir.exists(here("results", "PRJNA392914"))) {
  dir.create(here("results", "PRJNA392914", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA392914", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA392914", "rds-files", "se.rds"))
```
