...
```{r}
if (!dir.exists(here("results", "PRJNA400080"))) {
  dir.create(here("results", "PRJNA400080", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA400080", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA400080", "rds-files", "se.rds"))
```
