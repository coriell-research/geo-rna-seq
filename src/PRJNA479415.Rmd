...
venetoclax_azacitidine_6hr <- setDT(
  coriell::edger_to_df(
    glmTreat(fit, coef = 4, lfc = log2(fc))
    )
  )
```
...
```{r}
venetoclax_azacitidine_6hr[, contrast := "Venetoclax_Azacitidine_vs_DMSO_6hr"]
df <- dplyr::select(venetoclax_azacitidine_6hr, contrast, dplyr::everything())
