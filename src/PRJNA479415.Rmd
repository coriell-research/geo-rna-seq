...
```{r}
if (!dir.exists(here("results", "PRJNA479415"))) {
  dir.create(here("results", "PRJNA479415", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA479415", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA479415", "rds-files", "se.rds"))
```
