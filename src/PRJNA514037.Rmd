...
```{r}
if (!dir.exists(here("results", "PRJNA514037"))) {
  dir.create(here("results", "PRJNA514037", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA514037", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA514037", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA514037", "rds-files", "se.rds"))
```
