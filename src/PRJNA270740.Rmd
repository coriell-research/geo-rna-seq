...
```{r}
if (!dir.exists(here("results", "PRJNA270740"))) {
  dir.create(here("results", "PRJNA270740", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA270740", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA270740", "rds-files", "se.rds"))
```
