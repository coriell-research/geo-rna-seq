---
title: "Test Qsmooth vs RUVseq vs TMM Normalization"
...
# create alternate design for RUVg estimates
W <- as.numeric(ruvg$W)
...
## Run `RUVSeq` on the filtered counts

Use the 'stable' repeat elements as control genes. Use the stable 50 by BCV. 
These are the repeats which were present in at least 50% of lists of the top
500 most invariant REs across all experiments.

```{r eval=FALSE, include=FALSE}
# read in the 'stable' REs
stableRE_10_bcv <- readRDS("../../results/normalization/rds-files/stableRE-10-bcv.rds")
stableRE_10_union <- readRDS("../../results/normalization/rds-files/stableRE-10-union.rds")
stableRE_25_bcv <- readRDS("../../results/normalization/rds-files/stableRE-25-bcv.rds")
stableRE_25_union <- readRDS("../../results/normalization/rds-files/stableRE-25-union.rds")
stableRE_33_bcv <- readRDS("../../results/normalization/rds-files/stableRE-33-bcv.rds")
stableRE_33_union <- readRDS("../../results/normalization/rds-files/stableRE-33-union.rds")
stableRE_50_bcv <- readRDS("../../results/normalization/rds-files/stableRE-50-bcv.rds")
stableRE_50_union <- readRDS("../../results/normalization/rds-files/stableRE-50-union.rds")

controls <- intersect(rownames(y$counts), stableRE_10_bcv)
ruvg <- RUVSeq::RUVg(x = y$counts, cIdx = controls, k = 1)
```
...
lcpm.ruv <- cpm(y = ruvg$normalizedCounts, prior.count = 2, log = TRUE)
...
p2.ruv <- plotDensity(qs_dt.m, "RUVg Normalized")

# Combine into patchwork
(p.raw | p.tmm | p.qs | p.ruv) / (p2.raw | p2.tmm | p2.qs | p2.ruv) +
...
(b.raw | b.tmm | b.qs | b.ruv) +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
ggsave(here("results", "normalization", "figures", "biplots.png"), width = 20, height = 6)
```
...
disp.ruv <- estimateDisp(y$counts, design = design.ruv, robust = TRUE)
...
fit.ruv <- glmQLFit(y = y$counts, design = design.ruv, dispersion = disp.ruv$trended.dispersion, robust = TRUE)
```
...
hh1_vs_dmso.2.ruv <- setDT(edger_to_df(glmTreat(fit.ruv, contrast = contrast.matrix2[, "hh1_vs_dmso.2"], lfc = log2(1.2))))
...
v4 <- plot_volcano(hh1_vs_dmso.2.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")
...
m4 <- plot_md(hh1_vs_dmso.2.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")

(v1 | v2 | v3 | v4) / (m1 | m2 | m3 | m4) +
  plot_annotation(title = "HH1 10um vs DMSO - 2hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
...
hh1_vs_dmso.4.ruv <- setDT(edger_to_df(glmTreat(fit.ruv, contrast = contrast.matrix2[, "hh1_vs_dmso.4"], lfc = log2(1.2))))
...
v4 <- plot_volcano(hh1_vs_dmso.4.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")
...
m4 <- plot_md(hh1_vs_dmso.4.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")

(v1 | v2 | v3 | v4) / (m1 | m2 | m3 | m4) +
  plot_annotation(title = "HH1 10um vs DMSO - 4hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
...
hh1_vs_dmso.8.ruv <- setDT(edger_to_df(glmTreat(fit.ruv, contrast = contrast.matrix2[, "hh1_vs_dmso.8"], lfc = log2(1.2))))
...
v4 <- plot_volcano(hh1_vs_dmso.8.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")
...
m4 <- plot_md(hh1_vs_dmso.8.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")

(v1 | v2 | v3 | v4) / (m1 | m2 | m3 | m4) +
  plot_annotation(title = "HH1 10um vs DMSO - 8hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
...
hh1_vs_dmso.24.ruv <- setDT(edger_to_df(glmTreat(fit.ruv, contrast = contrast.matrix2[, "hh1_vs_dmso.24"], lfc = log2(1.2))))
...
v4 <- plot_volcano(hh1_vs_dmso.24.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")
...
m4 <- plot_md(hh1_vs_dmso.24.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")

(v1 | v2 | v3 | v4) / (m1 | m2 | m3 | m4) +
  plot_annotation(title = "HH1 10um vs DMSO - 24hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
...
hh1_vs_dmso.96.ruv <- setDT(edger_to_df(glmTreat(fit.ruv, contrast = contrast.matrix2[, "hh1_vs_dmso.96"], lfc = log2(1.2))))
...
v4 <- plot_volcano(hh1_vs_dmso.96.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")
...
m4 <- plot_md(hh1_vs_dmso.96.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")

(v1 | v2 | v3 | v4) / (m1 | m2 | m3 | m4) +
  plot_annotation(title = "HH1 10um vs DMSO - 96hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
...
dac_vs_dmso.96.ruv <- setDT(edger_to_df(glmTreat(fit.ruv, contrast = contrast.matrix2[, "dac_vs_dmso.96"], lfc = log2(1.2))))
dac_hh1_10_vs_dmso.96.ruv <- setDT(edger_to_df(glmTreat(fit.ruv, contrast = contrast.matrix2[, "dac_hh1_10_vs_dmso.96"], lfc = log2(1.2))))
dac_hh1_25_vs_dmso.96.ruv <- setDT(edger_to_df(glmTreat(fit.ruv, contrast = contrast.matrix2[, "dac_hh1_25_vs_dmso.96"], lfc = log2(1.2))))
tetOff_vs_tetOn.72.ruv <- setDT(edger_to_df(glmTreat(fit.ruv, contrast = contrast.matrix2[, "tetOff_vs_tetOn.72"], lfc = log2(1.2))))
...
v4 <- plot_volcano(dac_vs_dmso.96.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")
...
m4 <- plot_md(dac_vs_dmso.96.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")

(v1 | v2 | v3 | v4) / (m1 | m2 | m3 | m4) +
  plot_annotation(title = "Decitabine vs DMSO - 96hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
...
v4 <- plot_volcano(dac_hh1_10_vs_dmso.96.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")
...
m4 <- plot_md(dac_hh1_10_vs_dmso.96.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")

(v1 | v2 | v3 | v4) / (m1 | m2 | m3 | m4) +
  plot_annotation(title = "Decitabine + HH1 10um vs DMSO - 96hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
...
v4 <- plot_volcano(dac_hh1_25_vs_dmso.96.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")
...
m4 <- plot_md(dac_hh1_25_vs_dmso.96.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")

(v1 | v2 | v3 | v4) / (m1 | m2 | m3 | m4) +
  plot_annotation(title = "Decitabine + HH1 25um vs DMSO - 96hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
...
v4 <- plot_volcano(tetOff_vs_tetOn.72.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")
...
m4 <- plot_md(tetOff_vs_tetOn.72.ruv, fdr = 0.1, lfc = log2(1.2)) + ggtitle("RUVg Normalization")

(v1 | v2 | v3 | v4) / (m1 | m2 | m3 | m4) +
  plot_annotation(title = "Tet Off vs Tet On - 72hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
...
(v1 | v2 | v3) / (m1 | m2 | m3) +
  plot_annotation(title = "MOLT JQ1 vs DMSO - 2hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
...
(v1 | v2 | v3) / (m1 | m2 | m3) +
  plot_annotation(title = "MOLT JQ1 vs DMSO - 6hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
...
(v1 | v2 | v3) / (m1 | m2 | m3) +
  plot_annotation(title = "MOLT dBET6 vs DMSO - 2hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
...
(v1 | v2 | v3) / (m1 | m2 | m3) +
  plot_annotation(title = "MOLT dBET6 vs DMSO - 6hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
...
(v1 | v2 | v3) / (m1 | m2 | m3) +
  plot_annotation(title = "PDX JQ1 vs DMSO - 0hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
...
(v1 | v2 | v3) / (m1 | m2 | m3) +
  plot_annotation(title = "PDX dBET6 vs DMSO - 0hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
...
(v1 | v2 | v3) / (m1 | m2 | m3) +
  plot_annotation(title = "Primary Cells JQ1 vs DMSO - 0hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
...
(v1 | v2 | v3) / (m1 | m2 | m3) +
  plot_annotation(title = "Primary Cells dBET6 vs DMSO - 0hr") +
  plot_layout(guides = "collect") &
  theme(legend.position = "bottom")
