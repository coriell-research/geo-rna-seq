...
```{r}
if (!dir.exists(here("results", "PRJNA670855"))) {
  dir.create(here("results", "PRJNA670855", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA670855", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA670855", "rds-files", "se.rds"))
```
