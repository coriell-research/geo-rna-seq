...
```{r}
metadata <- fread(here("doc", "2021-05-25-experiment-annotation.csv"))
...
```{r}
# specify a distinct color pallette for ALL colon drugs (some may be excluded in plots)
# iWantHue 17-colors
colon_cols <- c("#9e4365", "#5db645", "#885ccd", "#a2b046", "#ce53b0", "#5cbc82",
                "#d6425f", "#3fbfbc", "#cf552a", "#5773c3", "#d59b3c", "#62a0d8",
                "#827430", "#ae7bc1", "#467e45", "#dd80a0", "#c47655")
...
```{r}
bone_dge <- dge_se[, dge_se$tissue == "bone" & !dge_se$morphology %like% "primary"]
bone_dre <- dre_se[, dre_se$tissue == "bone" & !dge_se$morphology %like% "primary"]
...
```{r}
bone_cols <- c("#c65c8a", "#70a845", "#b05cc6", "#b69040", "#6e7ecb", "#cc5a43", "#4bad90")
...
```{r}
blood_dge <- dge_se[, dge_se$tissue == "blood" & !dge_se$morphology %like% "primary"]
blood_dre <- dre_se[, dre_se$tissue == "blood" & !dge_se$morphology %like% "primary"]
...
```{r}
blood_cols <- c("#d08dce", "#65b54d", "#a758c7", "#c3ae40", "#5e70da", "#d05a2a",
                "#59a0d5", "#d24c59", "#4bae8b", "#d04798", "#6f8038", "#7962a6",
                "#bf7f4b", "#b45e74")
...
```{r}
breast_dge <- dge_se[, dge_se$tissue == "breast" & !dge_se$morphology %like% "primary"]
breast_dre <- dre_se[, dre_se$tissue == "breast" & !dge_se$morphology %like% "primary"]
...
```{r}
breast_cols <- c("#cb5756", "#60a862", "#ba5fb2", "#b6923e", "#6a7fcf")
...
```{r}
bowel_dge <- dge_se[, dge_se$tissue %like% "pancreas" & !dge_se$morphology %like% "primary"]
bowel_dre <- dre_se[, dre_se$tissue %like% "pancreas" & !dge_se$morphology %like% "primary"]
...
```{r}
skin_dge <- dge_se[, dge_se$tissue %like% "skin" & !dge_se$morphology %like% "primary" & !is.na(dge_se$drug)]
skin_dre <- dre_se[, dre_se$tissue %like% "skin" & !dge_se$morphology %like% "primary" & !is.na(dre_se$drug)]
...
```{r}
skin_cols <- c("#737a34", "#a365c5", "#77b544", "#d4468d", "#52ae87", "#c95938",
               "#6587cd", "#cc9b46", "#c26276")
...
```{r}
lung_dge <- dge_se[, dge_se$tissue %like% "lung" & !dge_se$morphology %like% "primary"]
lung_dre <- dre_se[, dre_se$tissue %like% "lung" & !dge_se$morphology %like% "primary"]
...
```{r}
lung_cols <- c("#9ab63e", "#7b62cb", "#5aba54", "#c163b9", "#428b54", "#cf4a40",
               "#52c1ab", "#c75980", "#cea340", "#688ccd", "#c17547", "#7b8139")
...
```{r}
kidney_dge <- dge_se[, dge_se$tissue %like% "kidney" & !dge_se$morphology %like% "primary"]
kidney_dre <- dre_se[, dre_se$tissue %like% "kidney" & !dge_se$morphology %like% "primary"]
