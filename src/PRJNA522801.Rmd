...
```{r}
if (!dir.exists(here("results", "PRJNA522801"))) {
  dir.create(here("results", "PRJNA522801", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA522801", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA522801", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA522801", "rds-files", "se.rds"))
```
