...
```{r}
if (!dir.exists(here("results", "PRJNA422779"))) {
  dir.create(here("results", "PRJNA422779", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA422779", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA422779", "rds-files", "se.rds"))
```
