...
contrast.matrix <- makeContrasts(
  G12V.MS275.1 = G12V.MS275.1 - G12V.DMSO.1,
  G12V.MS275.6 = (G12V.MS275.6 - G12V.MS275.1) - (G12V.DMSO.6 - G12V.DMSO.1),
  G12V.MS275.24 = (G12V.MS275.24 - G12V.MS275.1) - (G12V.DMSO.24 - G12V.DMSO.1),
  G12V.MS275.72 = (G12V.MS275.72 - G12V.MS275.1) - (G12V.DMSO.72 - G12V.DMSO.1),
  
  WT.MS275.1 = WT.MS275.1 - WT.DMSO.1,
  WT.MS275.6 = (WT.MS275.6 - WT.MS275.1) - (WT.DMSO.6 - WT.DMSO.1),
  WT.MS275.24 = (WT.MS275.24 - WT.MS275.1) - (WT.DMSO.24 - WT.DMSO.1),
  WT.MS275.72 = (WT.MS275.72 - WT.MS275.1) - (WT.DMSO.72 - WT.DMSO.1),
...
names(cons) <- cons
titles <- c("G12V.MS275 vs DMSO 1hr", 
            "G12V.MS275 vs DMSO 6hr", 
            "G12V.MS275 vs DMSO 24hr", 
            "G12V.MS275 vs DMSO 72hr", 
            "WT.MS275 vs DMSO 1hr", 
            "WT.MS275 vs DMSO 6hr", 
            "WT.MS275 vs DMSO 24hr", 
            "WT.MS275 vs DMSO 72hr")
