...
```{r}
if (!dir.exists(here("results", "PRJNA273359"))) {
  dir.create(here("results", "PRJNA273359", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA273359", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA273359", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA273359", "rds-files", "se.rds"))
```
