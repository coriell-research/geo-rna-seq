...
```{r}
if (!dir.exists(here("results", "PRJNA752346"))) {
  dir.create(here("results", "PRJNA752346", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA752346", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA752346", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA752346", "rds-files", "se.rds"))
```
