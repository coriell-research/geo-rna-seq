...
```{r}
mae <- readRDS(here("data", "PRJNA297109", "MultiAssayExperiment.rds"))
```
...
```{r}
if (!dir.exists(here("results", "PRJNA297109"))) {
  dir.create(here("results", "PRJNA297109", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA297109", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA297109", "rds-files", "se.rds"))
```
