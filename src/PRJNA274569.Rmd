...
```{r}
if (!dir.exists(here("results", "PRJNA274569"))) {
  dir.create(here("results", "PRJNA274569", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA274569", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA274569", "rds-files", "se.rds"))
```
