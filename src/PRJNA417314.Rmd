...
mae <- readRDS(here("data", "PRJNA417314", "MultiAssayExperiment.rds"))
```
...
fwrite(
  ...
  file = here("results", "PRJNA417314", "data-files", "dge.tsv"),
  sep = "\t"
  )

fwrite(
  x = df[!feature_id %chin% cds$gene_name],
  file = here("results", "PRJNA417314", "data-files", "dre.tsv"),
  sep = "\t"
)
```
...
saveRDS(lcpms.gene, here("results", "PRJNA417314", "rds-files", "gene-lcpms.rds"))
saveRDS(lcpms.re, here("results", "PRJNA417314", "rds-files", "re-lcpms.rds"))
```

## Save design and contrast matrix

```{r}
saveRDS(design, here("results", "PRJNA417314", "rds-files", "design.rds"))
saveRDS(contrast.matrix, here("results", "PRJNA417314", "rds-files", "contrast-matrix.rds"))
```
