...
```{r}
if (!dir.exists(here("results", "PRJNA417314"))) {
  dir.create(here("results", "PRJNA417314", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA417314", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA417314", "rds-files", "se.rds"))
```
