...
se <- read_rds(here("data", "PRJNA315414", "summarized_experiment.rds"))
```
...
contrast.matrix <- makeContrasts(
  MOLT4.JQ1.2 = MOLT4.JQ1.2 - MOLT4.DMSO.2,
  MOLT4.JQ1.6 = (MOLT4.JQ1.6 - MOLT4.JQ1.2) - (MOLT4.DMSO.6 - MOLT4.DMSO.2),
  MOLT4.dBET6.2 = MOLT4.dBET6.2 - MOLT4.DMSO.2,
  MOLT4.dBET6.6 = (MOLT4.dBET6.6 - MOLT4.dBET6.2) - (MOLT4.DMSO.6 - MOLT4.DMSO.2),
  T_ALL_PDX.JQ1.0 = T_ALL_PDX.JQ1.0 - T_ALL_PDX.DMSO.0,
  T_ALL_PDX.dBET6.0 = T_ALL_PDX.dBET6.0 - T_ALL_PDX.DMSO.0,
  primary_T_cell.JQ1.0 = primary_T_cell.JQ1.0 - primary_T_cell.DMSO.0,
  primary_T_cell.dBET6.0 = primary_T_cell.dBET6.0 - primary_T_cell.DMSO.0,
...
names(cons) <- cons
titles <- c("MOLT4.JQ1.2", 
            "MOLT4.JQ1.6",
            "MOLT4.dBET6.2",
            "MOLT4.dBET6.6",
            "T_ALL_PDX.JQ1.0",
            "T_ALL_PDX.dBET6.0",
            "primary_T_cell.JQ1.0",
            "primary_T_cell.dBET6.0")
...
dge <- df %>% 
  ...
  write_tsv(here("results", "PRJNA315414", "data-files", "dge.tsv"))

dre <- df %>% 
  filter(!feature_id %in% cds$gene_name) %>% 
  write_tsv(here("results", "PRJNA315414", "data-files", "dre.tsv"))
```
...
write_rds(lcpms.gene, here("results", "PRJNA315414", "rds-files", "gene-lcpms.rds"))
write_rds(lcpms.re, here("results", "PRJNA315414", "rds-files", "re-lcpms.rds"))
```
