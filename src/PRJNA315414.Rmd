...
```{r}
if (!dir.exists(here("results", "PRJNA315414"))) {
  dir.create(here("results", "PRJNA315414", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA315414", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA315414", "rds-files", "se.rds"))
```
