...
```{r}
if (!dir.exists(here("results", "PRJNA350500"))) {
  dir.create(here("results", "PRJNA350500", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA350500", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA350500", "rds-files", "se.rds"))
```
