...
mae <- readRDS(here("data", "PRJNA350500", "MultiAssayExperiment.rds"))
```
...
fwrite(
  ...
  file = here("results", "PRJNA350500", "data-files", "dge.tsv"),
  sep = "\t"
  )

fwrite(
  x = df[!feature_id %chin% cds$gene_name],
  file = here("results", "PRJNA350500", "data-files", "dre.tsv"),
  sep = "\t"
)
```
...
saveRDS(lcpms.gene, here("results", "PRJNA350500", "rds-files", "gene-lcpms.rds"))
saveRDS(lcpms.re, here("results", "PRJNA350500", "rds-files", "re-lcpms.rds"))
```

## Save design and contrast matrix

```{r}
saveRDS(design, here("results", "PRJNA350500", "rds-files", "design.rds"))
saveRDS(contrast.matrix, here("results", "PRJNA350500", "rds-files", "contrast-matrix.rds"))
```
