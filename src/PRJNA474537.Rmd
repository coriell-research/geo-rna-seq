...
```{r}
if (!dir.exists(here("results", "PRJNA474537"))) {
  dir.create(here("results", "PRJNA474537", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA474537", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA474537", "rds-files", "se.rds"))
```
