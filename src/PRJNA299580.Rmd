...
```{r}
if (!dir.exists(here("results", "PRJNA299580"))) {
  dir.create(here("results", "PRJNA299580", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA299580", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA299580", "rds-files", "se.rds"))
```
