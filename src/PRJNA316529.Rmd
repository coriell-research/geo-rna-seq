...
```{r}
if (!dir.exists(here("results", "PRJNA316529"))) {
  dir.create(here("results", "PRJNA316529", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA316529", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA316529", "rds-files", "se.rds"))
```
