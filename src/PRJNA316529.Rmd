...
mae <- readRDS(here("data", "PRJNA316529", "MultiAssayExperiment.rds"))
```
...
fwrite(
  ...
  file = here("results", "PRJNA316529", "data-files", "dge.tsv"),
  sep = "\t"
  )

fwrite(
  x = df[!feature_id %chin% cds$gene_name],
  file = here("results", "PRJNA316529", "data-files", "dre.tsv"),
  sep = "\t"
)
```
...
saveRDS(lcpms.gene, here("results", "PRJNA316529", "rds-files", "gene-lcpms.rds"))
saveRDS(lcpms.re, here("results", "PRJNA316529", "rds-files", "re-lcpms.rds"))
```

## Save design and contrast matrix

```{r}
saveRDS(design, here("results", "PRJNA316529", "rds-files", "design.rds"))
saveRDS(contrast.matrix, here("results", "PRJNA316529", "rds-files", "contrast-matrix.rds"))
```
...
fviz_eig(pca.gene, addlabels = TRUE) +
  ...
  ggsave(here("results", "PRJNA316529", "figures", "gene-scree.png"),
         width = 8,
         height = 5)

fviz_eig(pca.re, addlabels = TRUE) +
  ggtitle("Repetitive Elements") +
  ggsave(here("results", "PRJNA316529", "figures", "re-scree.png"),
         width = 8,
         height = 5)
...
ind.gene$coord %>% 
  ...
  theme_light() +
  ggsave(here("results", "PRJNA316529", "figures", "gene-pca.png"),
         width = 8,
         height = 5)
# REs
ind.re$coord %>% 
  ...
  scale_color_brewer(palette = "Dark2") +
  theme_light() +
  ggsave(here("results", "PRJNA316529", "figures", "re-pca.png"),
         width = 8,
         height = 5)
```
...
quickmap(lcpms.sig_genes, 
         ...
         filename = here("results", "PRJNA316529", "figures", "gene-heatmap.png"))

quickmap(lcpms.sig_res, 
         annotation_col = col_df,
         annotation_colors = ann_colors,
         main = paste("Significant (FDR <", sig, ") Repetitive Elements"),
         filename = here("results", "PRJNA316529", "figures", "re-heatmap.png"))
```
...
# Gene
(gene_vplots[[1]] + scale_y_continuous(limits = c(0, 6)) + scale_x_continuous(limits = c(-20, 20)) | 
 gene_vplots[[2]] + scale_y_continuous(limits = c(0, 6)) + scale_x_continuous(limits = c(-20, 20)) | 
 gene_vplots[[3]] + scale_y_continuous(limits = c(0, 6)) + scale_x_continuous(limits = c(-20, 20))) /
(gene_mdplots[[1]] + scale_y_continuous(limits = c(-20, 20)) |
 gene_mdplots[[2]] + scale_y_continuous(limits = c(-20, 20)) | 
 gene_mdplots[[3]] + scale_y_continuous(limits = c(-20, 20))) +
plot_annotation("Protein Coding Gene Expression") +
plot_layout(guides = "collect") +
ggsave(here("results", "PRJNA316529", "figures", "gene-patchwork.png"),
       width = 18, 
       height = 10)

# RE
(re_vplots[[1]] + scale_y_continuous(limits = c(0, 5)) + scale_x_continuous(limits = c(-6, 6)) | 
 re_vplots[[2]] + scale_y_continuous(limits = c(0, 5)) + scale_x_continuous(limits = c(-6, 6)) | 
 re_vplots[[3]] + scale_y_continuous(limits = c(0, 5)) + scale_x_continuous(limits = c(-6, 6))) /
(re_mdplots[[1]] + scale_y_continuous(limits = c(-6, 6)) + scale_x_continuous(limits = c(-6, 8))|
 re_mdplots[[2]] + scale_y_continuous(limits = c(-6, 6)) + scale_x_continuous(limits = c(-6, 8))| 
 re_mdplots[[3]] + scale_y_continuous(limits = c(-6, 6)) + scale_x_continuous(limits = c(-6, 8))) +
plot_annotation("RE Expression") +
plot_layout(guides = "collect") +
ggsave(here("results", "PRJNA316529", "figures", "re-patchwork.png"),
       width = 18, 
       height = 10)
```
...
ggsave(here("results", "PRJNA316529", "figures", "dotplots.png"),
       width = 18,
       height = 7)
```
