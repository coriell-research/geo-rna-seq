...
contrast.matrix <- makeContrasts(
  dac = dac - control,
  dac_deazaneplanocinA = dac_deazaneplanocinA - control,
  deazaneplanocinA = deazaneplanocinA - control,
  levels = design
)
...
titles <- c("DAC vs Control",
            "DAC + Deazaneplanocin A vs Control",
            "Deazaneplanocin A vs Control")
