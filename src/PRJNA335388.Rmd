...
contrast.matrix <- makeContrasts(
  ...
  doxorubicin.1uM = ((MDA.doxorubicin_1uM + U2OS.doxorubicin_1uM) / 2) - ((MDA.dmso + U2OS.dmso) / 2),
  etoposide.20uM = ((MDA.etoposide_20uM + U2OS.etoposide_20uM) / 2) - ((MDA.dmso + U2OS.dmso) / 2),
  mms.40ug_ml = ((MDA.mms_40ug_ml + U2OS.mms_40ug_ml) / 2) - ((MDA.dmso + U2OS.dmso) / 2),
  paclitaxel.02uM = ((MDA.paclitaxel_0.2uM + U2OS.paclitaxel_0.2uM) / 2) - ((MDA.dmso + U2OS.dmso) / 2), 
