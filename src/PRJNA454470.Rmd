...
```{r}
if (!dir.exists(here("results", "PRJNA454470"))) {
  dir.create(here("results", "PRJNA454470", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA454470", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA454470", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA454470", "rds-files", "se.rds"))
```
