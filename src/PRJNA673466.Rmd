...
```{r}
if (!dir.exists(here("results", "PRJNA673466"))) {
  dir.create(here("results", "PRJNA673466", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA673466", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA673466", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA673466", "rds-files", "se.rds"))
```
