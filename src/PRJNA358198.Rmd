...
```{r}
if (!dir.exists(here("results", "PRJNA358198"))) {
  dir.create(here("results", "PRJNA358198", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA358198", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA358198", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA358198", "rds-files", "se.rds"))
```
