...
```{r}
if (!dir.exists(here("results", "PRJNA352461"))) {
  dir.create(here("results", "PRJNA352461", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA352461", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA352461", "rds-files", "se.rds"))
```
