...
```{r}
if (!dir.exists(here("results", "PRJNA296592"))) {
  dir.create(here("results", "PRJNA296592", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA296592", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA296592", "rds-files", "se.rds"))
```
