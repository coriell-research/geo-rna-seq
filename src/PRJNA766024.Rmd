...
```{r}
if (!dir.exists(here("results", "PRJNA766024"))) {
  dir.create(here("results", "PRJNA766024", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA766024", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA766024", "rds-files", "se.rds"))
```
