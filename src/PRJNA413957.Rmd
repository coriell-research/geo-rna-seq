...
```{r}
if (!dir.exists(here("results", "PRJNA413957"))) {
  dir.create(here("results", "PRJNA413957", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA413957", "data-files"))
}
```
...
## ONLY INCLUDE TIME-SERIES DATA 

```{r eval=FALSE, include=FALSE}
mae <- mae[, mae$group %like% "^hh1\\.10uM\\.[0-9]+|^dmso\\.\\.[0-9]+"]
```
...
saveRDS(se, here("results", "PRJNA413957", "rds-files", "se.rds"))
```
