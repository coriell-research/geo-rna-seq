...
```{r}
if (!dir.exists(here("results", "PRJNA555350"))) {
  dir.create(here("results", "PRJNA555350", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA555350", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA555350", "rds-files", "se.rds"))
```
