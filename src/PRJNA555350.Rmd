...
contrast.matrix <- makeContrasts(
  dox_cta_dac = doxorubicin_cytabine_decitabine - control,
  dox_cta = doxorubicin_cytabine - control,
  dox = doxorubicin - control,
  levels = design
)
...
names(cons) <- cons
titles <- c("Doxorubicin + Cytabine + Decitabine vs Control", 
            "Doxorubicin + Cytabine vs Control", 
