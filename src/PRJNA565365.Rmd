...
```{r}
if (!dir.exists(here("results", "PRJNA565365"))) {
  dir.create(here("results", "PRJNA565365", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA565365", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA565365", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA565365", "rds-files", "se.rds"))
```
