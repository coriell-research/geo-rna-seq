...
```{r}
if (!dir.exists(here("results", "PRJNA509783"))) {
  dir.create(here("results", "PRJNA509783", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA509783", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA509783", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA509783", "rds-files", "se.rds"))
```
