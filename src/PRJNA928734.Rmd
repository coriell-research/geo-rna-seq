...
```{r}
if (!dir.exists(here("results", "PRJNA928734"))) {
  dir.create(here("results", "PRJNA928734", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA928734", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA928734", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA928734", "rds-files", "se.rds"))
```
