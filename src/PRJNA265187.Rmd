...
mae <- readRDS(here("data", "PRJNA265187", "MultiAssayExperiment.rds"))
```
...
```{r}
keep_cols <- !colnames(mae) == "SRR1634333"
mae <- mae[, keep_cols]
```
...
fwrite(
  ...
  file = here("results", "PRJNA265187", "data-files", "dge.tsv"),
  sep = "\t"
  )

fwrite(
  x = df[!feature_id %chin% cds$gene_name],
  file = here("results", "PRJNA265187", "data-files", "dre.tsv"),
  sep = "\t"
)
```
...
saveRDS(lcpms.gene, here("results", "PRJNA265187", "rds-files", "gene-lcpms.rds"))
saveRDS(lcpms.re, here("results", "PRJNA265187", "rds-files", "re-lcpms.rds"))
```

## Save design and contrast matrix

```{r}
saveRDS(design, here("results", "PRJNA265187", "rds-files", "design.rds"))
saveRDS(contrast.matrix, here("results", "PRJNA265187", "rds-files", "contrast-matrix.rds"))
```
...
fviz_eig(pca.gene, addlabels = TRUE) +
  ...
  ggsave(here("results", "PRJNA265187", "figures", "gene-scree.png"),
         width = 8,
         height = 5)

fviz_eig(pca.re, addlabels = TRUE) +
  ggtitle("Repetitive Elements") +
  ggsave(here("results", "PRJNA265187", "figures", "re-scree.png"),
         width = 8,
         height = 5)
...
ind.gene$coord %>% 
  ...
  theme_light() +
  ggsave(here("results", "PRJNA265187", "figures", "gene-pca.png"),
         width = 8,
         height = 5)
# REs
ind.re$coord %>% 
  ...
  scale_color_brewer(palette = "Dark2") +
  theme_light() +
  ggsave(here("results", "PRJNA265187", "figures", "re-pca.png"),
         width = 8,
         height = 5)
```
...
trt_colors <- RColorBrewer::brewer.pal(n = nlevels(col_df$group), "Dark2")
names(trt_colors) <- levels(col_df$group)

# put colors in list
ann_colors <- list(group = trt_colors)
...
quickmap(lcpms.sig_genes, 
         ...
         filename = here("results", "PRJNA265187", "figures", "gene-heatmap.png"))

quickmap(lcpms.sig_res, 
         annotation_col = col_df,
         annotation_colors = ann_colors,
         main = paste("Significant (FDR <", sig, ") Repetitive Elements"),
         filename = here("results", "PRJNA265187", "figures", "re-heatmap.png"))
```
...
# Gene volcano
(gene_vplots[[1]] + scale_y_continuous(limits = c(0, 15)) + scale_x_continuous(limits = c(-12, 12)) |
 gene_vplots[[2]] + scale_y_continuous(limits = c(0, 15)) + scale_x_continuous(limits = c(-12, 12)) |
 gene_vplots[[3]] + scale_y_continuous(limits = c(0, 15)) + scale_x_continuous(limits = c(-12, 12)) ) / 
(gene_vplots[[4]] + scale_y_continuous(limits = c(0, 15)) + scale_x_continuous(limits = c(-12, 12)) |
 gene_vplots[[5]] + scale_y_continuous(limits = c(0, 15)) + scale_x_continuous(limits = c(-12, 12)) |
 plot_spacer()) +
plot_annotation("Protein Coding Gene Expression") +
plot_layout(guides = "collect") +
ggsave(here("results", "PRJNA265187", "figures", "gene-vplot.png"),
       width = 18,
       height = 10)

# RE volcano
(re_vplots[[1]] + scale_y_continuous(limits = c(0, 10)) + scale_x_continuous(limits = c(-8, 8)) |
 re_vplots[[2]] + scale_y_continuous(limits = c(0, 10)) + scale_x_continuous(limits = c(-8, 8)) |
 re_vplots[[3]] + scale_y_continuous(limits = c(0, 10)) + scale_x_continuous(limits = c(-8, 8)) ) / 
(re_vplots[[4]] + scale_y_continuous(limits = c(0, 10)) + scale_x_continuous(limits = c(-8, 8)) |
 re_vplots[[5]] + scale_y_continuous(limits = c(0, 10)) + scale_x_continuous(limits = c(-8, 8)) |
 plot_spacer()) +
plot_annotation("RE Expression") +
plot_layout(guides = "collect") +
ggsave(here("results", "PRJNA265187", "figures", "re-vplot.png"),
       width = 18,
       height = 10)
...
plot_annotation("Protein Coding Gene Expression") +
plot_layout(guides = "collect") +
ggsave(here("results", "PRJNA265187", "figures", "gene-mdplot.png"),
       width = 18,
       height = 10)

# RE MD
(re_mdplots[[1]] + scale_y_continuous(limits = c(-8, 8)) |
 re_mdplots[[2]] + scale_y_continuous(limits = c(-8, 8)) |
 re_mdplots[[3]] + scale_y_continuous(limits = c(-8, 8)) ) /
(re_mdplots[[4]] + scale_y_continuous(limits = c(-8, 8)) | 
 re_mdplots[[5]] + scale_y_continuous(limits = c(-8, 8)) |
 plot_spacer()) +
plot_annotation("RE Expression") +
plot_layout(guides = "collect") +
ggsave(here("results", "PRJNA265187", "figures", "re-mdplot.png"),
       width = 18,
       height = 10)
```
...
ggsave(here("results", "PRJNA265187", "figures", "dotplots.png"),
       width = 18,
       height = 7)
```
