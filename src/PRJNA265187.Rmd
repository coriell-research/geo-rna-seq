...
```{r}
if (!dir.exists(here("results", "PRJNA265187"))) {
  dir.create(here("results", "PRJNA265187", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA265187", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA265187", "rds-files", "se.rds"))
```
