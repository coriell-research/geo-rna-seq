...
```{r}
if (!dir.exists(here("results", "PRJNA298835"))) {
  dir.create(here("results", "PRJNA298835", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA298835", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA298835", "rds-files", "se.rds"))
```
