...
```{r}
if (!dir.exists(here("results", "PRJNA516226"))) {
  dir.create(here("results", "PRJNA516226", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA516226", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA516226", "rds-files", "se.rds"))
```
