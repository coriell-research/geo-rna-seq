...
```{r}
if (!dir.exists(here("results", "PRJNA244098"))) {
  dir.create(here("results", "PRJNA244098", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA244098", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA244098", "rds-files", "se.rds"))
```
