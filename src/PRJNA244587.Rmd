...
```{r}
if (!dir.exists(here("results", "PRJNA244587"))) {
  dir.create(here("results", "PRJNA244587", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA244587", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA244587", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA244587", "rds-files", "se.rds"))
```
