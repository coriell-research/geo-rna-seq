...
```{r}
if (!dir.exists(here("results", "PRJNA533647"))) {
  dir.create(here("results", "PRJNA533647", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA533647", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA533647", "rds-files", "se.rds"))
```
