...
```{r}
if (!dir.exists(here("results", "PRJNA641077"))) {
  dir.create(here("results", "PRJNA641077", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA641077", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA641077", "rds-files", "se.rds"))
```
