...
```{r}
if (!dir.exists(here("results", "PRJNA476608"))) {
  dir.create(here("results", "PRJNA476608", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA476608", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA476608", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA476608", "rds-files", "se.rds"))
```
