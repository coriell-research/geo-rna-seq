...
se <- readRDS(here("data", "PRJNA685849", "summarized_experiment.rds"))
```
...
contrast.matrix <- makeContrasts(
  CDDP_50uM_4hr = CDDP_50uM_4hr - untreated_4hr,
  CDDP_50uM_10hr = (CDDP_50uM_10hr - CDDP_50uM_4hr) - (untreated_10hr - untreated_4hr),
  CDDP_50uM_20hr = (CDDP_50uM_20hr - CDDP_50uM_4hr) - (untreated_20hr - untreated_4hr),
  Hypercin_150nM_irradiation_4hr = Hypercin_150nM_irradiation_4hr - untreated_4hr,
  Hypercin_150nM_irradiation_10hr = (Hypercin_150nM_irradiation_10hr - Hypercin_150nM_irradiation_4hr) - (untreated_10hr - untreated_4hr),
  Hypercin_150nM_irradiation_20hr = (Hypercin_150nM_irradiation_20hr - Hypercin_150nM_irradiation_4hr) - (untreated_20hr - untreated_4hr),
  MTX_1um_4hr = MTX_1um_4hr - untreated_4hr,
  MTX_1um_10hr = (MTX_1um_10hr - MTX_1um_4hr) - (untreated_10hr - untreated_4hr),
  MTX_1um_20hr = (MTX_1um_20hr - MTX_1um_4hr) - (untreated_20hr - untreated_4hr),
...
names(cons) <- cons
titles <- c("CPPP 50uM vs Untreated at 4hrs",
            "CPPP 50uM vs Untreated at 10hrs",
            "CPPP 50uM vs Untreated at 20hrs",
            "Hypercin 150nM + irradiation vs Untreated at 4hrs",
            "Hypercin 150nM + irradiation vs Untreated at 10hrs",
            "Hypercin 150nM + irradiation vs Untreated at 20hrs",
            "MTX 1uM vs Untreated at 4hrs",
            "MTX 1uM vs Untreated at 10hrs",
            "MTX 1uM vs Untreated at 20hrs")
...
dge <- df %>% 
  ...
  write_tsv(here("results", "PRJNA685849", "data-files", "dge.tsv"))

dre <- df %>% 
  filter(!feature_id %in% cds$gene_name) %>% 
  write_tsv(here("results", "PRJNA685849", "data-files", "dre.tsv"))
```
...
write_rds(lcpms.gene, here("results", "PRJNA685849", "rds-files", "gene-lcpms.rds"))
write_rds(lcpms.re, here("results", "PRJNA685849", "rds-files", "re-lcpms.rds"))
```
