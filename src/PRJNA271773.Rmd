...
```{r}
if (!dir.exists(here("results", "PRJNA271773"))) {
  dir.create(here("results", "PRJNA271773", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA271773", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA271773", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA271773", "rds-files", "se.rds"))
```
