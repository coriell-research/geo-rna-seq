...
```{r}
if (!dir.exists(here("results", "PRJNA511587"))) {
  dir.create(here("results", "PRJNA511587", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA511587", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA511587", "MultiAssayExperiment.rds"))
```
...
perm_pval <- min(c(perm_pval.treatment, perm_pval.cell_line))
```
...
saveRDS(se, here("results", "PRJNA511587", "rds-files", "se.rds"))
```
