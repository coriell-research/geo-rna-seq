...
```{r}
if (!dir.exists(here("results", "PRJNA596778"))) {
  dir.create(here("results", "PRJNA596778", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA596778", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA596778", "rds-files", "se.rds"))
```
