...
```{r}
if (!dir.exists(here("results", "PRJNA387040"))) {
  dir.create(here("results", "PRJNA387040", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA387040", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA387040", "rds-files", "se.rds"))
```
