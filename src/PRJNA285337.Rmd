...
```{r}
if (!dir.exists(here("results", "PRJNA285337"))) {
  dir.create(here("results", "PRJNA285337", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA285337", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA285337", "rds-files", "se.rds"))
```
