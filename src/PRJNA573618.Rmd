...
```{r}
if (!dir.exists(here("results", "PRJNA573618"))) {
  dir.create(here("results", "PRJNA573618", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA573618", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA573618", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA573618", "rds-files", "se.rds"))
```
