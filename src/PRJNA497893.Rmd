...
```{r}
if (!dir.exists(here("results", "PRJNA497893"))) {
  dir.create(here("results", "PRJNA497893", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA497893", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA497893", "rds-files", "se.rds"))
```
