...
```{r}
if (!dir.exists(here("results", "PRJNA515688"))) {
  dir.create(here("results", "PRJNA515688", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA515688", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA515688", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA515688", "rds-files", "se.rds"))
```
