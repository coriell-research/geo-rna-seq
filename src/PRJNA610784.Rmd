...
```{r}
if (!dir.exists(here("results", "PRJNA610784"))) {
  dir.create(here("results", "PRJNA610784", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA610784", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA610784", "rds-files", "se.rds"))
```
