...
```{r}
if (!dir.exists(here("results", "PRJNA614994"))) {
  dir.create(here("results", "PRJNA614994", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA614994", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA614994", "rds-files", "se.rds"))
```
