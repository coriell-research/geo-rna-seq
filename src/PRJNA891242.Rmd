...
```{r}
if (!dir.exists(here("results", "PRJNA891242"))) {
  dir.create(here("results", "PRJNA891242", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA891242", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA891242", "MultiAssayExperiment.rds"))
```
...
saveRDS(se, here("results", "PRJNA891242", "rds-files", "se.rds"))
```
