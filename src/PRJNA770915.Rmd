...
```{r}
if (!dir.exists(here("results", "PRJNA770915"))) {
  dir.create(here("results", "PRJNA770915", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA770915", "data-files"))
}
```
...
```{r}
mae <- readRDS(here("data", "PRJNA770915", "MultiAssayExperiment.rds"))
```
...
contrast.matrix <- makeContrasts(
  HCT116.OTS964_30nM.4h_vs_HCT116.DMSO.4h =
    HCT116.OTS964_30nM.4h - HCT116.DMSO.4h,
...
saveRDS(se, here("results", "PRJNA770915", "rds-files", "se.rds"))
```
