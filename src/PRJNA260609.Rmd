...
```{r}
if (!dir.exists(here("results", "PRJNA260609"))) {
  dir.create(here("results", "PRJNA260609", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA260609", "data-files"))
}
```
...
Since there are no real groups here, check against each of the grouping factors.
...
perm_pval <- mean(c(perm_pval.drug, perm_pval.mutation))
```
...
saveRDS(se, here("results", "PRJNA260609", "rds-files", "se.rds"))
```
