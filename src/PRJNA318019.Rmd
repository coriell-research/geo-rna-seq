...
```{r}
if (!dir.exists(here("results", "PRJNA318019"))) {
  dir.create(here("results", "PRJNA318019", "rds-files"), recursive = TRUE)
  dir.create(here("results", "PRJNA318019", "data-files"))
}
```
...
saveRDS(se, here("results", "PRJNA318019", "rds-files", "se.rds"))
```
